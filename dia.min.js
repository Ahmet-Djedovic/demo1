(function (global) {
  global.$_Tawk_AccountKey = "5f0425a2760b2b560e6fe069";
  global.$_Tawk_WidgetId = "1eh7d9ccm";
  ...
  (function (global) {
    global.$_Tawk.widgetSettings = {
      ...
      offlineForm: {
        ...
        fields: [
          { label: "Name", isRequired: true, type: "name" },
          { label: "Email", isRequired: true, type: "email" },
  ...
  (function (b) {
    ...
    a.form.QuestionErrorMessage = {
      message:
        "Question is required and must not be longer then 500 characters.",
    };
    a.form.MessageErrorMessage = {
      message:
        "Message is required and must not be longer then 500 characters.",
    };
    ...
    a.overlay.tawkContent = {
      message:
        "This widget is powered by DiamantLED.",
    };
    a.chat = {};
    ...
    a.chat.seconds = {
      vars: [],
      pluralVars: ["num"],
      message: { one: "#num second", other: "#num seconds" },
    };
    a.chat.minutes = {
      vars: [],
      pluralVars: ["num"],
      message: { one: "#num minute", other: "#num minutes" },
    };
    a.chat.hours = {
      vars: [],
      pluralVars: ["num"],
      message: { one: "#num hour", other: "#num hours" },
    };
    b.$_Tawk.language = a;
  ...
  (function () {
    !(function (u) {
      ...
      return (function g(p, q, h) {
        ...
        for (
          var k = "function" == typeof require && require, d = 0;
          d < h.length;
          d++
        )
          m(h[d]);
      ...
      })(
        {
          ...
          4: [
            function (g, p, q) {
              p.exports = function (h, m, k) {
                ...
                m = m || 0;
                k = k || d;
                if (h.slice) return h.slice(m, k);
                0 > m && (m += d);
                0 > k && (k += d);
                k > d && (k = d);
                if (m >= d || m >= k || 0 === d) return new ArrayBuffer(0);
                h = new Uint8Array(h);
                for (var d = new Uint8Array(k - m), g = 0; m < k; m++, g++)
                  d[g] = h[m];
                return d.buffer;
              };
            },
              ...
              (function (h) {
                q.encode = function (m) {
                  ...
                  for (k = 0; k < d; k += 3)
                    (g += h[m[k] >> 2]),
                      (g += h[((m[k] & 3) << 4) | (m[k + 1] >> 4)]),
                      (g += h[((m[k + 1] & 15) << 2) | (m[k + 2] >> 6)]),
                      (g += h[m[k + 2] & 63]);
                  2 === d % 3
                    ? (g = g.substring(0, g.length - 1) + "=")
                    : 1 === d % 3 && (g = g.substring(0, g.length - 2) + "==");
                  return g;
                };
                q.decode = function (m) {
                  var k = 0.75 * m.length,
                  ...
                  "=" === m[m.length - 1] &&
                    (k--, "=" === m[m.length - 2] && k--);
                  for (
                    var w = new ArrayBuffer(k), O = new Uint8Array(w), k = 0;
                    k < d;
                    k += 4
                  )
                    (p = h.indexOf(m[k])),
            ...
            function (g, p, q) {
              ...
              h.prototype.emit = function (h) {
                ...
                var k = [].slice.call(arguments, 1),
                  d = this._callbacks[h];
                if (d)
                  for (var d = d.slice(0), g = 0, p = d.length; g < p; ++g)
                    d[g].apply(this, k);
                return this;
              };
              ...
              (function (h) {
                function m(b, d) {
                  ...
                  b
                    ? ((b = t(b)),
                      (d.hostname = b.host),
                      (d.secure = "https" == b.protocol || "wss" == b.protocol),
                      (d.port = b.port),
                      b.query && (d.query = b.query))
                    : d.host && (d.hostname = t(d.host).host);
                  this.secure =
                    null != d.secure
                      ? d.secure
                  ...
                  "string" == typeof this.query &&
                    (this.query = w.decode(this.query));
                  ...
                  this.perMessageDeflate =
                    !1 !== d.perMessageDeflate ? d.perMessageDeflate || {} : !1;
                  ...
                  this.rejectUnauthorized =
                    void 0 === d.rejectUnauthorized ? !0 : d.rejectUnauthorized;
                  var k = "object" == typeof h && h;
                  k.global === k &&
                    d.extraHeaders &&
                    0 < Object.keys(d.extraHeaders).length &&
                    (this.extraHeaders = d.extraHeaders);
                  this.open();
                }
                var k = g("./transports"),
                  d = g("component-emitter"),
                  q = g("debug")("engine.io-client:socket"),
                  x = g("indexof"),
                ...
                m.prototype.probe = function (b) {
                  function d() {
                    if (t.onlyBinaryUpgrades) {
                      var c =
                        !this.supportsBinary && t.transport.supportsBinary;
                      r = r || c;
                    }
                    r ||
                      (q('probe transport "%s" opened', b),
                      v.send([{ type: "ping", data: "probe" }]),
                      v.once("packet", function (c) {
                        r ||
                          ("pong" == c.type && "probe" == c.data
                  ...
                  function z(b) {
                    v &&
                      b.name != v.name &&
                      (q('"%s" works - aborting "%s"', b.name, v.name), h());
                  }
                  function p() {
                ...
                m.prototype.onOpen = function () {
                  ...
                  if (
                    ...
                    for (var b = 0, d = this.upgrades.length; b < d; b++)
                ...
                m.prototype.sendPacket = function (b, d, h, k) {
                ...
                m.prototype.close = function () {
                  ...
                  function d() {
                    ...
                    k.removeListener("upgradeError", d);
                    b();
                  }
                  function h() {
                    k.once("upgrade", d);
                ...
                m.prototype.filterUpgrades = function (b) {
                  for (var d = [], h = 0, k = b.length; h < k; h++)
                    ~x(this.transports, b[h]) && d.push(b[h]);
                  return d;
                };
              }.call(
                this,
              ...
              (function (h) {
                ...
                q.polling = function (g) {
                  ...
                  h.location &&
                    ...
                    (b = g.hostname != location.hostname || b != g.port),
                    (p = g.secure != p));
                  g.xdomain = b;
                  g.xscheme = p;
          ...
          16: [
            function (g, p, q) {
              (function (h) {
                ...
                function q() {
                  for (var b in d.requests)
                    d.requests.hasOwnProperty(b) && d.requests[b].abort();
                }
                      ...
                      if (this.extraHeaders) {
                        ...
                        for (var m in this.extraHeaders)
                          this.extraHeaders.hasOwnProperty(m) &&
                            g.setRequestHeader(m, this.extraHeaders[m]);
                      }
                    } catch (s) {}
                ...
                d.prototype.onLoad = function () {
                  ...
                  try {
                    ...
                    if ("application/octet-stream" === d) b = this.xhr.response;
          ...
          17: [
            function (g, p, q) {
              ...
              var b =
                null !=
                new (g("xmlhttprequest-ssl"))({ xdomain: !1 }).responseType;
              q(h, m);
              ...
              h.prototype.write = function (b) {
                ...
                var g = function () {
                  ...
                  h = this;
                d.encodePayload(b, this.supportsBinary, function (b) {
                  h.doWrite(b, g);
                });
              };
            ...
            function (g, p, q) {
              (function (h) {
                ...
                m.prototype.write = function (b) {
                  ...
                  var k = this;
                  this.writable = !1;
                  for (var m = b.length, c = 0, p = m; c < p; c++)
                    (function (b) {
                      d.encodePacket(b, k.supportsBinary, function (c) {
                        if (!H) {
                          ...
                          k.perMessageDeflate &&
                            ("string" == typeof c
                              ? h.Buffer.byteLength(c)
                              : c.length) < k.perMessageDeflate.threshold &&
                            (d.compress = !1);
                        }
                        try {
                ...
                m.prototype.check = function () {
                  return (
                    !!w &&
                    !("__initialize" in w && this.name === m.prototype.name)
                  );
                };
              }.call(
                this,
          ...
          19: [
            function (g, p, q) {
              ...
              p.exports = function (g) {
                ...
                g = g.enablesXDR;
                try {
                  if ("undefined" != typeof XMLHttpRequest && (!k || h))
                    return new XMLHttpRequest();
                } catch (p) {}
                try {
                  if ("undefined" != typeof XDomainRequest && !d && g)
              ...
              (function (h) {
                    ...
                    return (
                      d
                        ? W
                          ...
                          : ((d = new Uint8Array(1)),
                            (d[0] = P[b.type]),
                            (b = new c([d.buffer, b.data])),
                            (b = k(b)))
                        : (b = q.encodeBase64Packet(b, k)),
                      b
                    );
                  if (p && p.base64)
                    return k("b" + q.packets[b.type] + b.data.data);
                  d = P[b.type];
                  void 0 !== b.data &&
                    (d += g ? H.encode(String(b.data)) : String(b.data));
                  return k("" + d);
                };
                q.encodeBase64Packet = function (b, d) {
                  ...
                  try {
                    ...
                    for (var s = Array(m.length), t = 0; t < m.length; t++)
                      s[t] = m[t];
                ...
                q.decodePacket = function (b, d, h) {
                  if ("string" == typeof b || void 0 === b) {
                    if ("b" == b.charAt(0))
                      return q.decodeBase64Packet(b.substr(1), d);
                    if (h)
                      try {
                        b = H.decode(b);
                      } catch (g) {
                    ...
                    h = b.charAt(0);
                    return Number(h) == h && X[h]
                      ? 1 < b.length
                        ? { type: X[h], data: b.substring(1) }
                        : { type: X[h] }
                      : s;
                  }
                ...
                q.decodeBase64Packet = function (d, g) {
                  var k = X[d.charAt(0)];
                  if (!h.ArrayBuffer)
                    return { type: k, data: { base64: !0, data: d.substr(1) } };
                  var m = b.decode(d.substr(1));
                  "blob" === g && c && (m = new c([m]));
                  return { type: k, data: m };
                };
                ...
                q.decodePayload = function (b, c, d) {
                  if ("string" != typeof b)
                    return q.decodePayloadAsBinary(b, c, d);
                  ...
                  for (var g, k, m = 0, p = b.length; m < p; m++)
                    if (((k = b.charAt(m)), ":" != k)) h += k;
                      ...
                      if ("" == h || h != (g = Number(h))) return d(s, 0, 1);
                      k = b.substr(m + 1, g);
                      if (h != k.length) return d(s, 0, 1);
                      if (k.length) {
                        h = q.decodePacket(k, c, !0);
                        if (s.type == h.type && s.data == h.data)
                          return d(s, 0, 1);
                  ...
                  k(
                    ...
                    function (b, d) {
                      ...
                      d.forEach(function (b) {
                        ...
                        if (c) {
                          for (
                            var d = new Uint8Array(b.length), h = 0;
                            h < b.length;
                            h++
                          )
                            d[h] = b.charCodeAt(h);
                  ...
                  k(
                    ...
                    function (b, d) {
                      q.encodePacket(b, !0, !0, function (b) {
                        ...
                        if ("string" === typeof b) {
                          for (
                            var g = new Uint8Array(b.length), k = 0;
                            k < b.length;
                            k++
                          )
                            g[k] = b.charCodeAt(k);
                        ...
                        for (
                          var g = (b instanceof ArrayBuffer
                              ? b.byteLength
                              : b.size
                            ).toString(),
                            l = new Uint8Array(g.length + 1),
                            k = 0;
                          k < g.length;
                          k++
                        )
                ...
                q.decodePayloadAsBinary = function (b, c, d) {
                  ...
                  for (var h = [], g = !1; 0 < b.byteLength; ) {
                    for (
                      var k = new Uint8Array(b), m = 0 === k[0], p = "", l = 1;
                      255 != k[l];
                      l++
                    ) {
                      if (310 < p.length) {
                    ...
                    if (m)
                      try {
                        ...
                        for (
                          m = new Uint8Array(k), k = "", l = 0;
                          l < m.length;
                          l++
                        )
                          k += String.fromCharCode(m[l]);
                      }
                    h.push(k);
                    b = x(b, p);
                  }
              ...
              (function (h) {
                ...
                p.exports = function (g) {
                  function d(g) {
                    if (!g) return !1;
                    if (
                      (h.Buffer && h.Buffer.isBuffer(g)) ||
                      (h.ArrayBuffer && g instanceof ArrayBuffer) ||
                      (h.Blob && g instanceof Blob) ||
                      (h.File && g instanceof File)
                    )
                      return !0;
                    if (m(g))
          ...
          24: [
            function (g, p, q) {
              ...
              p.exports = function (g, k) {
                ...
                for (var d = 0; d < g.length; ++d) if (g[d] === k) return d;
                return -1;
              };
            },
            {},
            ...
            function (g, p, q) {
              (function (h) {
                ...
                p.exports = function (p) {
                  ...
                  if (g.test(p.replace(k, "@").replace(d, "]").replace(q, "")))
              ...
              q.encode = function (h) {
                ...
                for (k in h)
                  h.hasOwnProperty(k) &&
                    (g.length && (g += "&"),
                    (g +=
                      encodeURIComponent(k) + "=" + encodeURIComponent(h[k])));
                return g;
              };
              q.decode = function (h) {
                var g = {};
            ...
            function (g, p, q) {
              ...
              p.exports = function (g) {
                ...
                -1 != p &&
                  ...
                  (g =
                    g.substring(0, p) +
                    g.substring(p, q).replace(/:/g, ";") +
                    g.substring(q, g.length));
                g = h.exec(g || "");
                for (var b = {}, t = 14; t--; ) b[m[t]] = g[t] || "";
                -1 != p &&
                  -1 != q &&
                  ((b.source = d),
                  (b.host = b.host
          ...
          29: [
            function (g, p, q) {
              (function (g) {
                (function (m) {
                  function k(b) {
                    for (var c = [], d = 0, g = b.length, h, k; d < g; )
                      (h = b.charCodeAt(d++)),
                        55296 <= h && 56319 >= h && d < g
                          ? ((k = b.charCodeAt(d++)),
                            56320 == (k & 64512)
                              ? c.push(((h & 1023) << 10) + (k & 1023) + 65536)
                              : (c.push(h), d--))
                          : c.push(h);
                    return c;
                  }
          ...
          30: [
            function (g, p, q) {
              ...
              for (
                var k = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(
                    ""
                  ),
                  d = 64,
                  R = {},
  ...
  (function (u) {
    ...
    u.prototype.emit = function (p) {
      ...
      if (g(h)) {
        ...
        for (var h = h.slice(), m = 0, k = h.length; m < k; m++)
          h[m].apply(this, q);
        return !0;
      }
      return !1;
    ...
    u.prototype.removeAllListeners = function (g) {
      g
        ? g && this._events && this._events[g] && (this._events[g] = null)
        : (this._events = {});
      return this;
    };
  ...
  (function (u) {
    ...
    for (p in EventEmitter.prototype)
      "function" === typeof EventEmitter.prototype[p] &&
        ...
        (g.prototype[p] = EventEmitter.prototype[p]);
    ...
    g.prototype.onMessage = function (g) {
      (g = this.decode(g)) &&
        ("__callback__" === g.c
          ? this.executeCallback(g)
          : this.emit.apply(this, [g.c].concat(g.p)));
    };
    ...
    g.prototype.decode = function (g) {
      ...
      this.debug &&
        ...
        console.log &&
        ((data = new Date()),
        console.log("received " + data.toUTCString() + " : " + g));
      try {
        m = JSON.parse(g);
      } catch (k) {
        this.emit("error", k);
    ...
    g.prototype.send = function () {
      ...
      this.debug &&
        ...
        console.log &&
        ((data = new Date()),
        console.log("send " + data.toUTCString() + " : " + g));
      this.state !== q.OPEN
        ? this.emit(
            "error",
            Error(
    ...
    g.prototype.encode = function (g) {
      ...
      if (g[0]) {
        ...
        "function" === typeof g[g.length - 1] &&
          (m.cb = this.enqueuCallback(g.pop()));
        m.p = g.slice(1);
        var k;
        try {
          k = JSON.stringify(m);
  ...
  (function (u) {
    ...
    try {
      ...
      var t = {
          ...
          "chat-resend-link":
            '<a id="resendMessage-__MESSAGE_ID__" href="#" class="messageStatus" title="Resend">__NOT_DELIVERED__</a><span class="icon-alert"></span> <span class="failed-label">__FAILED__</span>',
          "tawk-survey-wrapper":
          ...
          "default-branding":
            '<span class="thin">We\'re</span> <img class="emojione" alt="\u26a1" title=":zap:" src="https://cdn.jsdelivr.net/emojione/assets/png/26a1.png?v=2.2.7"> by <b>tawk.to</b>',
          fileUploadProgress:
          ...
          "emoji-selection":
            '<ul id="tabs-selection">__TAB_LIST__<li id="search" class="open-tab"><a href="#" class="emoji-header"><img class="emojione only-emoji" alt="search" title=":mag:" src="https://cdn.jsdelivr.net/emojione/assets/png/1f50d.png?v=2.2.7" /></a></li><div class="clearfix"></div></ul><div id="tab-content"></div>',
          "emoji-tab-pane":
          ...
          "emoji-tab-select":
            '<li class="open-tab" id="__ID__"><a href="#" class="emoji-header">__IMAGE__</a></li>',
          "emoji-list":
            '<a href="#" class="emoji-select" id="__SHORTNAME__" title="__SHORTNAME__">__IMAGE__</a>',
          changeNameForm:
          ...
          "tawkchat-chat-bubble-gallery":
            '<span id="tawkchat-chat-bubble-close" class="image-bubble-close"></span><img src="__IMAGE_SRC__" style="__IMAGE_SIZE__" /><a id="bubble-image" class="gallery-bubble" href="#"></a>',
      ...
      w.dependencyDetection = (function () {
        ...
        return {
          begin: function (e) {
            a.push(e && { callback: e, distinctDependencies: [] });
          },
          end: function () {
            a.pop();
          },
          registerDependency: function (e) {
            if (!w.isSubscribable(e))
              throw Error("Only subscribable things can act as dependencies");
            if (0 < a.length) {
              var b = a[a.length - 1];
              !b ||
                0 <= w.utils.arrayIndexOf(b.distinctDependencies, e) ||
                (b.distinctDependencies.push(e), b.callback(e));
            }
          },
          ignore: function (e, b, n) {
            try {
      ...
      w.observable = function (a) {
        function e() {
          if (0 < arguments.length)
            return (
              (e.equalityComparer && e.equalityComparer(b, arguments[0])) ||
                (e.valueWillMutate(), (b = arguments[0]), e.valueHasMutated()),
              this
            );
        ...
        w.utils.extend(e, w.observable.fn);
      ...
      w.subscribable.fn = {
        subscribe: function (a, e, b) {
          b = b || "change";
          a = e ? a.bind(e) : a;
          var n = new w.subscription(
            this,
            a,
            function () {
              w.utils &&
                w.utils.arrayRemoveItem &&
        ...
        notifySubscribers: function (a, e) {
          ...
          if (this.hasSubscriptionsForEvent(e)) {
            var b = this._subscriptions[e],
              n;
            n = 0;
            for (var B = this._subscriptions[e].length; n < B; ++n)
              (b = this._subscriptions[e].slice(0)),
                (b = b[n]) && !0 !== b.isDisposed && b.callback(a);
          }
        },
      ...
      w.hasPrototype = function (a, e) {
        return null === a || void 0 === a || void 0 === a[O]
          ? !1
          : a[O] === e
          ? !0
          : w.hasPrototype(a[O], e);
      };
      ...
      w.utils = {
        arrayIndexOf: function (a, e) {
          ...
          for (var b = 0, n = a.length; b < n; b++) if (a[b] === e) return b;
          return -1;
        },
        extend: function (a, e) {
          if (e) for (var b in e) e.hasOwnProperty(b) && (a[b] = e[b]);
          return a;
        },
      ...
      (function (a) {
        function e(a, e) {
          ...
          a = a.replace(r, ".");
          for (var b = a.split("."), n = b.length, B = []; n--; )
            B[n] = e(b[n]);
          b = B.join(".");
          return f + b;
        }
        function b(a) {
          for (var e = [], f = 0, n = a.length, B, c; f < n; )
            (B = a.charCodeAt(f++)),
              55296 <= B && 56319 >= B && f < n
                ? ((c = a.charCodeAt(f++)),
                  56320 == (c & 64512)
                    ? e.push(((B & 1023) << 10) + (c & 1023) + 65536)
                    : (e.push(B), f--))
                : e.push(B);
          return e;
        }
      ...
      if ("object" === typeof d.$_Tawk_API)
        for (var W in d.$_Tawk_API)
          d.$_Tawk_API.hasOwnProperty(W) && (d.Tawk_API[W] = d.$_Tawk_API[W]);
      ...
      var X = function () {
        k = {
          ...
          dispatch: function (a, e) {
            ...
            a &&
              ((f =
                "function" === typeof d.CustomEvent
                  ? new CustomEvent(a, { detail: e })
                  : new b.CustomEventIE(a, { detail: e })),
              d.dispatchEvent(f));
          },
        };
      };
      ...
      u.getWindowType = Tawk_API.getWindowType = function () {
        if (u.ready)
          return c.isEmbedded ? "embed" : c.isPopup ? "popup" : "inline";
      };
      ...
      u.widgetPosition = Tawk_API.widgetPosition = function () {
      ...
      A.prototype.parseQueryString = function (a) {
        ...
        a = 0;
        for (e = n.length; a < e; a += 1)
          (b = n[a].split("=")), (B[b[0]] = b[1]);
        return B;
      };
      ...
      A.prototype.getReloadedScript = function () {
        ...
        for (e = b.length; a < e; a++)
          b[a].id && -1 !== b[a].id.indexOf("TawkScript") && (n = b[a]);
        return n;
      };
      ...
      A.prototype.getDepartmentStatus = function (a) {
        ...
        return { status: B, isOnline: c, name: d };
      };
      A.prototype.getElementsByClassName = function (a, e) {
        var b, n, B, c;
        if (a.getElementsByClassName) return a.getElementsByClassName(e);
        B = a.getElementsByTagName("*");
        c = [];
        b = 0;
        for (n = B.length; b < n; b++)
          -1 !== B[b].className.indexOf(e) && c.push(B[b]);
        return c;
      };
      ...
      A.prototype.shadeColor = function (a, e) {
        ...
        e = e || 0;
        for (c = 0; 6 > c; c += 2)
          (n = parseInt(a[c] + "" + a[c + 1], 16)),
            (n = Math.round(Math.min(Math.max(0, n + n * e), 255)).toString(
              16
            )),
            (b += ("00" + n).substring(n.length));
        return b;
      };
      ...
      A.prototype.getElementsByTagName = function (a, e) {
        for (
          var b = [], n = a.getElementsByTagName(e), c = 0;
          c < n.length;
          c++
        )
          b.push(n[c]);
      ...
      A.prototype.formatFileSize = function (a) {
        ...
        for (var b = 1; b < e.length; b++)
          if (a < Math.pow(1024, b))
            return (
              Math.round(100 * (a / Math.pow(1024, b - 1))) / 100 + e[b - 1]
            );
        return a;
      };
      ...
      A.prototype.transformGreetings = function (a) {
        for (
          var b = /\[([^)]+)\]/,
            f = /\(([^)]+)\)/,
            n = /\[[^\]\(\)]+\]\((\bhttp:\/\/\b|\bhttps:\/\/\b|\bmailto:\b){1}[^\]\(\)]+\)/i,
            c = "_blank",
            d = a,
            g,
            h;
        ...
        var n = 1e4 * Math.random(),
          ...
          k = function () {
            if (
              ...
              e.cssText !== a.style.cssText ||
              l.h(a.innerHTML) !== c.key
            )
              B.whiteLabelUnexpectedIssueLogged ||
                (b.loggingHandler.logIncident(
                  "White label element has changed unexpectedly",
                  { pageId: z.uuid }
                ),
                (B.whiteLabelUnexpectedIssueLogged = !0)),
                (a.id = e.id),
                (a.innerHTML = e.label),
                (a.style.cssText = e.cssText),
                null !== e.url ? (a.href = e.url) : a.removeAttribute("href"),
                !d.getElementById(e.parentElem.id) &&
                  e.grandParentName &&
                  ((g = d.getElementById(e.grandParentName)),
                  e.siblingName &&
                    (h = d.getElementById(e.siblingName)) &&
                    g &&
                    g.insertBefore(e.parentElem, h)),
                (g = d.getElementById(e.parentElem.id)),
                !d.getElementById(a.id) && g && g.appendChild(a);
            B.checkWhiteLabelLink(a, e, f);
          };
        f
          ? (this.messagePreviewCheckWhiteLabelRef = setTimeout(k, n))
          : (this.checkWhiteLabelRef = setTimeout(k, n));
      };
      A.prototype.applyWhiteLabelSettings = function (a, b, f) {
        f
          ? clearTimeout(this.messagePreviewCheckWhiteLabelRef)
          : clearTimeout(this.checkWhiteLabelRef);
        null === b.url
          ? a.removeAttribute("href")
          : ((a.href = b.url), (b.url = a.href));
      ...
      A.prototype.insertRandomTagsBeforeAndAfter = function (a, b, f) {
      ...
      A.prototype.getWebRTCToken = function (a, e, f) {
        ...
        b.socketManager.sendToConnector("getWebRTCToken", a, function (a, b) {
          if (a) return n.webrtcWin.close(), f(!0, a);
          n.webrtcWin.location.href =
            n.connectionUrl + "/v2/call?token=" + b.data.token;
          f();
        });
      };
      ...
      A.prototype.isDescendent = function (a, b) {
      ...
      A.prototype.getTimeDifference = function (a, e) {
        ...
        36e5 <= diff
          ? ((f = Math.round(diff / 36e5)), (n = "hours"))
          : 6e4 <= diff
          ? ((f = Math.round(diff / 6e4)), (n = "minutes"))
          : ((f = Math.round(diff / 1e3)), (n = "seconds"));
        return b.languageParser.translate("chat", n, { num: f });
      };
        ...
        if (a && (a !== document || c.isPopup)) {
          ...
          l.supportsLatin(c.locale) && !b
            ? ((a.querySelector("head").innerHTML +=
              ...
              this.addClass(f, "font-lato"))
            : !l.supportsLatin(c.locale) &&
              b &&
              (b.parentNode.removeChild(b), this.removeClass(f, "font-lato"));
        }
      };
      A.prototype.updateFonts = function () {
        if (
          ...
          for (
            var a = b.viewHandler.iframeContainer.childViews, e = 0;
            e < a.length;
            e++
          ) {
            var f = a[e];
      ...
      A.prototype.h = function (a) {
        ...
        for (var f = 0; f < a.length; f++)
          var n = a.charCodeAt(f), b = (b << 5) - b + n, b = b & b;
        return b;
      };
      Inheritance_Manager = {
        extend: function (a, b) {
      ...
      Z.prototype.init = function () {
        ...
        "explorer" === s.vendor &&
          ...
          6 === s.version
            ? (s.isIE6 = !0)
            : 8 <= s.version && 9 > s.version && (s.isIE8 = !0));
      };
      Z.prototype.getBrowserVersion = function () {
        return this.browserObj
          ? this.browserObj
          : (this.browserObj = {
              vendor: this.searchString(Xa) || "other",
              version:
      ...
      Z.prototype.getPlugins = function () {
        var a,
          ...
          f = [];
        a = 0;
        for (b = x.plugins.length; a < b; a++)
          x.plugins[a].name && f.push(x.plugins[a].name);
        return f;
      };
      Z.prototype.searchString = function (a) {
        ...
        for (b = 0; b < a.length; b++)
          if (
            ((f = a[b].string),
            (n = RegExp(a[b].subString)),
            (this.versionSearchString = a[b].versionSearch || a[b].identity),
            n.test(f))
          )
            return a[b].identity;
      };
      Z.prototype.searchVersion = function (a) {
      ...
      Z.prototype.getMobileBrowser = function () {
        for (
          var a = !1, b = x.userAgent, f = Object.keys(Ga), n = 0;
          !a && n < f.length;
      ...
      Z.prototype.getReferredSearchEngine = function () {
        ...
        if (document.referrer && (b = this.getHostname(document.referrer)))
          for (a in ((b = b.toLowerCase()), Pa))
            if (0 <= b.indexOf(a)) {
              queryString = this.getQuerystring(document.referrer, Pa[a]);
              "blekko" === a &&
                "" === queryString &&
      ...
      Z.prototype.getQuerystring = function (a, b) {
        ...
        b = b.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
        f = RegExp("[\\?&]" + b + "=([^&#]*)").exec(a);
        return null === f || !l.isArray(f) || 2 > f.length
          ? null
          : f[1]
          ? unescape(f[1].replace(/\+/g, " "))
          : null;
      };
      Z.prototype.getHostname = function (a) {
        a = a.match(/^(?:f|ht)tp(?:s)?:\/\/([^/]+)/im);
        return null === a || !l.isArray(a) || 2 > a.length
          ? null
          : a[1]
          ? a[1].toString()
          : null;
      ...
      qa.prototype.log = function (a, b) {
        ...
        b &&
          ...
          ((b.uiVersion = "v3"),
          (b.buildVersion = "695"),
          (b.buildCommit = "e15e95f056d56d12773c04eb08c73fa5598007d9"),
          (f = { type: a, data: b }),
      ...
      Ia.prototype.handleError = function (a, e, f, n, c) {
        var d;
        if (
          !((e && f) || ("Script error." !== a && "Script error" !== a)) ||
          "string" !== typeof e ||
          (-1 === e.indexOf("tawk.to") && -1 === e.indexOf("tawk.js"))
        )
          return !1;
      ...
      ea.prototype.listen = function (a, b, f, n) {
        ...
        if (n) {
          this.events[n] &&
            ((c = this.events[n]),
            (this.events[n] = null),
            this.removeEventHandler(c.element, c.eventName, c.eventListener));
      ...
      Ja.prototype.xhrRequest = function (a, b, f) {
        ...
        n.onreadystatechange = function () {
          n.passed ||
            4 !== n.readyState ||
            ((n.passed = !0), f(null, n.responseText));
        };
      ...
      M.prototype.setHTTPCookie = function (a, b, f, n) {
        ...
        f ||
          ((f = new Date()),
          f.setTime(f.getTime() + 15552e6),
          (c = "; expires=" + f.toGMTString()));
        document.cookie =
          a + "=" + b + c + "; path=/" + (n ? ";domain=" + n : "");
      };
      M.prototype.getHTTPCookie = function (a) {
        ...
        for (b = d.length; a < b; a++) {
          for (f = d[a]; " " === f.charAt(0); ) f = f.substring(1, f.length);
          0 === f.indexOf(c) && n.push(f.substring(c.length, f.length));
        }
        return n;
      };
      M.prototype.setSessionStorage = function (a, b) {
      ...
      M.prototype.setWindowName = function (a) {
        (d.name && 0 !== d.name.indexOf("TawkWindowName-")) ||
          (d.name = "TawkWindowName-" + a);
      };
      M.prototype.getWindowName = function () {
        var a, b, f;
        if (!d.name) return null;
        if (0 !== d.name.indexOf("TawkWindowName-")) {
          f = d.name.substring(0, 5);
          b = f.length;
          if (6 > b) for (a = 0, b = 6 - b; a < b; a++) f += "0";
          ...
          (z.uuids &&
            ...
            z.uuids.forEach(function (b) {
              var f =
                ...
                z.uuidVer;
              a.isCookieEnabled &&
                a.setHTTPCookie("__tawkuuid", f, !1, b.domain);
            }));
        this.handleWindowId();
      ...
      M.prototype.storeSessionInformation = function (a, e) {
        ...
        if (!a || r.visitorSocketServer)
          a
            ...
            : ((f = n[1] || 0),
              b.main.previousSessionKey !== r.sessionKey && (f = 0),
              (f = r.visitorSocketServer + "::" + f)),
            e ? (f += "::cf") : 3 === n.length && (f += "::" + n[2]),
            this.hasLocalStorage
              ? (this.setLocalStorage("twk_" + L.pageId, f),
                this.clearOldCookies("Tawk_" + L.pageId))
              : this.setHTTPCookie("Tawk_" + L.pageId, f, !1),
            (this.sessionInformation = f);
      };
      ...
      Ka.prototype.initAudioPlayer = function () {
        ...
        if (s.html5audio.supported) {
          this.audioContext ||
            ...
            (void 0 === d.AudioContext && void 0 === d.webkitAudioContext) ||
            ((d.AudioContext = d.AudioContext || d.webkitAudioContext),
            (this.audioContext = new d.AudioContext()));
          s.html5audio.mp3
            ? (n = Ua)
            : s.html5audio.wav
            ? (n = Wa)
            : s.html5audio.ogg && (n = Va);
          for (a in n)
          ...
          this.audioContext &&
            ((f = function () {
              B.isReadyForInit &&
                B.eventUsedForInit &&
                !B.touchstartInited &&
                ((B.sounds[B.eventUsedForInit].volume = 0),
                B.sounds[B.eventUsedForInit].play(),
                B.sounds[B.eventUsedForInit].source.stop(0),
                (B.sounds[B.eventUsedForInit].volume = 1),
                d &&
                  "function" === typeof d.removeEventListener &&
                  d.removeEventListener("touchstart", f, !1),
                e &&
                  "function" === typeof e.removeEventListener &&
                  e.removeEventListener("touchstart", f, !1),
                (B.touchstartInited = !0));
            }),
            s.mobileBrowserName &&
              "ontouchstart" in d &&
      ...
      Ka.prototype.play = function (a) {
        k.disableSound ||
          (c.soundOn() && this.sounds[a] && this.sounds[a].play());
      };
      var La = function () {
        var a = this;
        this.uploads = {};
        ...
        b.eventEmitter.on("fileUploadFinished", function (e) {
          a.uploads[e.handle] &&
            (delete a.uploads[e.handle],
            b.viewHandler.fileUploaded(e.handle),
            b.chatHandler.sendFileMessage(e));
        });
      ...
      var ya,
        ...
        Na = function () {
          ...
          "undefined" === typeof a.emojione
            ...
            : (clearTimeout(ra),
              ...
              (G = a.emojione),
              (G.ascii = !0),
              (za = G.shortnames.replace(/\\\+/g, "+").split("|")));
        },
        Oa = function (a) {
          var e,
            f = "",
                ...
                : (clearTimeout(ra),
                  ...
                  setTimeout(function () {
                    Object.keys(Ma).forEach(function (a) {
                      f += c
                        .replace(/__ID__/, a)
                        .replace(/__IMAGE__/, G.shortnameToImage(Ma[a].header))
        ...
        Ra = function (a, e) {
          ...
          if (
            ...
            f =
              "open-tab" === e.target.className
                ? e.target
                : e.target.offsetParent;
            f = f.id;
            for (var m = 0; m < n.length; m++)
              n[m].className = n[m].id === f ? "open-tab active" : "open-tab";
            if ("search" === f)
              (B.innerHTML = t["emoji-search-pane"]),
                (B =
                  s.mobileBrowserName && c.isPopup
                    ? b.viewHandler.chatContainer.getElementById("search-emoji")
                    : g.container.getElementById("search-emoji")),
                b.eventHandler.listen(
                  B,
                  "keyup",
                  function (a) {
                    var e = b.eventHandler
                        .getTargetElement(a)
                        .value.trim()
                        .toLowerCase(),
                      f = t["emoji-list"],
                    ...
                    if (
                      (a =
                        s.mobileBrowserName && c.isPopup
                          ...
                          : g.container.getElementById("search-list")) &&
                      za
                    ) {
                      if (e)
                        for (var B = 0; B < za.length; B++) {
                          ...
                          -1 !== d.indexOf(e) &&
                            (n += f
                              .replace(/__IMAGE__/, G.shortnameToImage(d))
                              .replace(/__SHORTNAME__/g, d));
                        }
                      a.innerHTML = n;
                      Sa();
                    }
              ...
              n.content.forEach(function (a) {
                d += k
                  .replace(/__IMAGE__/, G.shortnameToImage(a))
                  .replace(/__SHORTNAME__/g, a);
              }),
                (B.innerHTML = h
                  .replace(/__EMOJIS__/, d)
        ...
        Sa = function () {
          for (
            var a = l.getElementsByClassName(ya, "emoji-select"), e = 0;
            e < a.length;
            e++
          )
        ...
        bb = function (a) {
          ...
          b.eventHandler.listen(
            ...
            function (a) {
              a = b.eventHandler.getTargetElement(a);
              "0" === a.getAttribute("data-moved") && Ta(a);
        ...
        Ta = function (a) {
          ...
          s.mobileBrowserName && c.isPopup
            ...
            : "max" === r.chatWindowState() || c.isPopup || c.isEmbedded
            ? g.addEmojiToInput(a)
      ...
      oa.prototype.init = function () {
        ...
        (null !== s.windowId && "null" !== s.windowId) ||
        ...
        this.socket.on("error", function (a) {
          ...
          if (a instanceof Error) {
            ...
            if (b.loggingHandler.unloading && -1 === f.toString.indexOf("post"))
              return;
            "TransportError" === a.type && (f.description = a.description);
            -1 !== f.toString.indexOf("post") && (c = "socket post error");
          } else f = a;
      ...
      oa.prototype.addEventListeners = function () {
        function a(a, e) {
          try {
        ...
        this.on("notifyWindowState", function (a) {
          e.chatWindowStates[a] && e.socket.send("chatWindowState", a);
        });
        ...
        this.on("notifyEndChatTranscript", function (a, b) {
          e.socket.send("sendTranscript", a, b);
        });
      ...
      oa.prototype.disconnectHandler = function () {
        u.connected = !1;
        this.socket.removeAllListeners();
        this.removeAllListeners();
        b.scheduler.cleanUp();
      ...
      D.prototype.buildView = function (a) {
        ...
        this.elementReferrer = l.createElement(
          this.documentRef,
          this.tagName,
          this.attributes,
          this.style,
      ...
      D.prototype.attachUserEventListener = function (a, e, f, n) {
        var c;
        if ((c = f ? this.getElementById(f) : this.elementReferrer))
          (f = a.split(" ")),
            1 < f.length
      ...
      ba.prototype.buildView = function (a) {
        this.documentRef = a || this.documentRef;
        return (this.elementReferrer = l.createElement(
          this.documentRef,
          "div",
          this.attributes,
          null,
      ...
      ba.prototype.addPlaceholderText = function (a, e, f, n, c) {
        ...
        s.isPlaceholderSupported || e || (e = d);
        (d && d !== f + "Placeholder") || ((d = e), (e = ""));
        if (n)
          return l.escapeTemplateReplacement(n, [
            { placeholder: c, textReplace: d },
            { placeholder: a, textReplace: e },
          ]);
          ...
          ((a = this.formData.fields) &&
            a.forEach(function (a) {
              ...
              "input" !== a.type ||
                ...
                ((d = a.getValue ? a.getValue() : ""),
                "input" === a.type && l.isArray(d)
                  ...
                  : a.hiddenIE8 ||
                    ((n = e.documentRef.getElementById(a.fieldName + "Field")),
                    (c = b.languageParser.translate(
                      "form",
                      a.languageKey + "Placeholder"
                    )),
                    l.togglePlaceholderText(n, c, a.fieldName + "Field"),
                    "textarea" !== n.tagName.toLowerCase() ||
                      l.trim(n.value) ||
                      (n.value = c)));
            }));
      ...
      ba.prototype.insertTranslatedTexts = function () {
        ...
        this.template = l.escapeTemplateReplacement(this.template, [
          ...
          },
          {
            ...
            textReplace: "safari" === s.vendor ? "safari-fix" : "",
          },
          {
        ...
        this.template = l.escapeTemplateReplacement(this.template, [
          { placeholder: "__CLOSE_BUTTON_CONTAINER__", textReplace: e },
        ]);
        this.formData.customButtons &&
          (this.template = l.escapeTemplateReplacement(
            this.template,
            this.formData.customButtons()
          ));
      };
      ...
      U.prototype.buildForm = function () {
        ...
        if (null === this.formData.dynamicFields) {
          for (var f = 0, n = c[a + "Options"].fields.length; f < n; f++) {
            ...
            "name" === g.type
              ? ((d.valueMaxLength = 40),
                (d.getValue = b.visitorHandler.getNameValue),
                (d.languageKey = "Name"))
              : "email" === g.type
              ? ((d.valueMaxLength = 150),
                (d.getValue = b.visitorHandler.getEmailValue),
                (d.validation = "isValidEmail"),
                (d.languageKey = "Email"))
              : "message" === g.type || "textArea" === g.type
              ? (d.valueMaxLength = 500)
              : "inputText" === g.type
              ? (d.valueMaxLength = 150)
              : "department" === g.type
              ? (d.getValue = b.sessionHandler.getDeparmentOptions)
              : "choice" === g.type || "option" === g.type
              ? ((d.type = "options"), (d.selections = g.selections))
              : "phone" === g.type &&
                ((d.valueMaxLength = 20),
                (d.validation = "isValidPhone"),
                (d.languageKey = "Phone"));
      ...
      U.prototype.generateDynamicFields = function () {
        for (
          var a = "",
            ...
            f = RegExp("__ID__", "gm"),
            n = RegExp("__MAXLENGTH__", "gm"),
            c = 0,
            d = this.formData.dynamicFields.length;
          c < d;
          c++
        ) {
          var g,
          ...
          else if ("message" === l.fieldType || "textArea" === l.fieldType)
            g = t.textAreaFieldType;
          else if ("department" === l.fieldType) g = t.departmentSelection;
          else if ("choice" === l.fieldType || "option" === l.fieldType)
            (g = t.selectionsType),
              (h =
                "choice" === l.fieldType
                  ? this.generateCheckboxOptions(l.fieldName, l.selections)
                  : this.generateRadioOptions(l.fieldName, l.selections));
          g &&
            ((g = g.replace(b, l.label || "")),
            (g = g.replace(f, l.fieldName || "")),
            (g = g.replace(n, l.valueMaxLength || "")),
            l.isRequired
              ? ((g = g.replace(/__REQUIRED__/gm, "*")),
                this.isFormRequired || (this.isFormRequired = !0))
              : (g = g.replace(/__REQUIRED__/gm, "")),
            l.getValue &&
              ("department" === l.fieldType
      ...
      U.prototype.generateDropDownOptions = function (a, e, f) {
        var n = "";
        ...
        "preChatForm" === this.formData.id || "offlineForm" === this.formData.id
          ? (n +=
              ...
              (e ? "* " : "") +
              (f ? f : b.languageParser.translate("form", "department")) +
              "</option>")
          : e || (n += '<option value="0"></option>');
        e = 0;
        for (f = a.length; e < f; e++)
          n +=
            ...
            a[e].value +
            '"' +
            (a[e].selected ? 'selected="selected"' : "") +
            ">" +
            a[e].text +
            "</option>";
        return n;
      ...
      U.prototype.generateRadioOptions = function (a, b) {
        for (
          var f = "", n = t.radioSelectionType, c = 0, d = b.length;
          c < d;
          c++
        )
          f += n
            .replace(/__ID__/gm, a + "radio" + c)
            .replace(/__FIELD_ID__/gm, a)
            .replace(/__VALUE__/gm, b[c]);
        return f;
      };
      U.prototype.generateCheckboxOptions = function (a, b) {
        for (
          var f = "", n = t.checkboxSelectionType, c = 0, d = b.length;
          c < d;
          c++
        )
          f += n
            .replace(/__ID__/gm, a + "check" + c)
            .replace(/__FIELD_ID__/gm, a)
            .replace(/__VALUE__/gm, b[c]);
        return f;
      };
      ...
      U.prototype.addPlaceholderHandler = function () {
        ...
        if (!s.isPlaceholderSupported)
          for (var f = 0, n = this.formData.dynamicFields.length; f < n; f++)
            (b = this.formData.dynamicFields[f]),
              "department" !== b.fieldType &&
                "choice" !== b.fieldType &&
                "option" !== b.fieldType &&
                ((this.formData.dynamicFields[f].placeholderText =
                  (b.isRequired ? "* " : "") + b.label),
                (a = this.documentRef.getElementById(b.fieldName + "Field")),
                l.togglePlaceholderText(
                  a,
                  this.formData.dynamicFields[f].placeholderText,
                  b.fieldName + "Field"
                ),
                l.trim(a.value) ||
                  (a.value = this.formData.dynamicFields[f].placeholderText));
      };
      var ia = function (a) {
        var e = this;
        this.container = a;
      ...
      ia.prototype.show = function () {
        ...
        if (
          !(
            ("max" === r.chatWindowState() && !c.isPopup) ||
          ...
          if (
            (e = this.container.getElementById("tawkchat-chat-indicator-text"))
          )
            e.innerHTML = this.unansweredMessages;
          a &&
      ...
      ia.prototype.hide = function () {
        ...
        this.container &&
          ...
          a &&
            ...
            s.mobileBrowserName || this.container.hide()),
          e && (e.innerHTML = ""));
      };
      ...
      E.prototype.init = function () {
        ...
        this.container &&
          (this.wrapper ||
            ...
            c.isRTL() && (this.wrapper.className += "rtl-direction ")),
          s.mobileBrowserName
        ...
        0 !== a &&
          ...
          this.messagePreviewContainer ||
            ...
            c.isCenterPositioned()
              ...
              : (this.messagePreviewContainer.style.maxHeight =
                  document.documentElement.clientHeight -
                  (c.minimizedDimensions().height + c.widgetOffsetY + 300) +
                  "px"),
          ...
          p && p.hideBubble(),
          e && !s.mobileBrowserName
            ? this.appendMessage(e)
            : f &&
              (f.isMissed
                ? this.appendCallInfo(f)
                : (this.messagePreviewCount--, this.appendCallRequest(f))),
          ...
          0 === this.messagePreviewCount
            ...
            : (c.showPreChatForm &&
                ...
                c.prechatOptions.fields.forEach(function (a) {
            ...
            ? ((e.style.display = "block"),
              this.container.attachUserEventListener(
                ...
                function (e) {
                  ...
                  if (e && e.length) {
                    for (var d = 0; d < e.length; d++)
                      e[d].size > a.maxSizeFileUpload
                        ? f.push(e[d])
                        : d >= a.maxNumberFileUpload
                        ? c.push(e[d])
                        : b.viewHandler.startUpload(e[d]);
              ...
              this.chatTextarea.attachUserEventListener(
                ...
                function (a) {
                  var e, f;
                  if (
                    (e = (a.originalEvent || a).clipboardData) &&
                    (e = e.items) &&
                    e.length
                  ) {
              ...
              this.container.attachUserEventListener(
                ...
                function (a) {
                  ...
                  -1 === f.className.indexOf(" drag-over") &&
                    l.addClass(f, "drag-over");
                },
                "actionsContainer",
                ...
                function (e) {
                  ...
                  if (e && 0 !== e.length) {
                    for (var g = 0; g < e.length; g++)
                      e[g].size > a.maxSizeFileUpload
                        ? c.push(e[g])
                        : g >= a.maxNumberFileUpload
                        ? d.push(e[g])
                        : b.viewHandler.startUpload(e[g]);
        ...
        c.isCenterPositioned()
          ? (-1 === this.wrapper.className.indexOf("center") &&
            ...
            c.isRightPositioned()
              ? (-1 === this.wrapper.className.indexOf("right") &&
                  (this.wrapper.className += " right"),
                (a.right = this.offsetX + f + 15 + "px !important"),
                (a.left = "auto !important"))
              : (-1 === this.wrapper.className.indexOf("left") &&
                  (this.wrapper.className += " left"),
                (a.left = this.offsetX + f + 15 + "px !important"),
                (a.right = "auto !important")))
          : (c.isTopPositioned()
              ? ((a.top =
                  c.minimizedDimensions().height +
                  this.offsetY +
                  "px !important"),
                (a.bottom = "auto !important"),
                -1 === this.wrapper.className.indexOf("top") &&
                  (this.wrapper.className += " top"))
              : (c.isDesktopRectangle()
                  ? (a.bottom =
                      c.minimizedDimensions().height +
                      this.offsetY +
                      10 +
        ...
        if (this.messagePreviewContainer && this.container)
          for (
            a = this.messagePreviewContainer.getElementsByClassName(
              ...
              f = this.container.documentRef.getElementById("textareaWrapper"),
      ...
      E.prototype.appendCallRequest = function (a) {
        ...
        var n = a.callId;
        f = (f =
          (a = v.agentProfiles[v.profiles[a.caller.urid]]) && a.pi
            ? r.agentImgUrl + "/" + a.pi
            : "")
          ? "url('" + f + "');"
          : "transparent;";
        b.chatHandler.webrtcWin && !b.chatHandler.webrtcWin.closed
          ...
          : ((e = e.replace(/__IMAGE_URL__/, f)),
            ...
            (e = this.container.getElementById("accept-call")),
      ...
      E.prototype.appendCallInfo = function (a) {
        if (!s.mobileBrowserName) {
          ...
          this.container &&
            this.messagePreviewContainer &&
            a &&
            ((p = b.languageParser.translate(
              "chat",
              "missed_visitor_messagePreview"
            )),
            (f = (e =
              (h = v.agentProfiles[v.profiles[g.urid]]) && h.pi
                ? r.agentImgUrl + "/" + h.pi
                : "")
              ? "url('" + e + "');"
              : "transparent;"),
            "transparent" !== f &&
              (f += "background-position:0 0;background-size:28px 28px"),
            (e = new D(
              d,
              null,
            ...
            (e.template = l.escapeTemplateReplacement(n, [
              { placeholder: "__CALL_INFO__", textReplace: p },
              { placeholder: "__CALLER_NAME__", textReplace: h.n },
              { placeholder: "__IMAGE_URL__", textReplace: f },
              {
            ...
            c.isTopPositioned()
              ...
              : this.messagePreviewContainer.appendChild(e.elementReferrer),
            (h = e.elementReferrer.getElementsByClassName("btn-icon")[0]),
            (p = e.elementReferrer.getElementsByClassName(
              "mp-callIconContainer"
            )[0]),
            a &&
              ((h.style.transform = "rotate(135deg)"),
              (h.style.top = "1px"),
              (p.style.backgroundColor = "#e52f48")),
            this.container.getElementById("incoming-call") &&
              (this.container.getElementById(
                "incoming-call"
              ).style.marginBottom = "10px"),
            this.prevSenderUid === v.profiles[g.urid] &&
              (q += " hidden-profile"),
            (e.elementReferrer.className += q),
            e.elementReferrer.setAttribute("data-uid", v.profiles[g.urid]),
            (wa = e.elementReferrer.getElementsByClassName(
            ...
            (e.elementReferrer.className += " animate-fade-object"));
        }
      };
      ...
      E.prototype.parseSurvey = function (a, b) {
        ...
        for (n = k.length; f < n; f++)
          (c = k[f].replace(l.regOption, "")),
            (c = c.replace(l.regBr, "")),
            (c = l.trim(c)),
            (h = g + f),
            (m += l.escapeTemplateReplacement(t["survey-option"], [
        ...
        a &&
          ...
          (h = a.profileImg
            ? a.profileImg
              ...
              : ""
            : (h = v.agentProfiles[a.ownerId]) && h.pi
            ? r.agentImgUrl + "/" + h.pi
            : ""),
          (h = h ? "url('" + h + "');" : "transparent;"),
          this.messagePreviewContainer &&
            ("undefined" !== typeof G &&
              ((g = G.unifyUnicode(g)),
              0 === g.replace(G.regUnicode, "").trim().length &&
                (m += " emojionly"),
              (g = G.toImage(g))),
            (g =
              "s" === a.senderType
                ? this.limitMessageLength(g, 500)
                : this.limitMessageLength(g, 150)),
            a.data &&
              a.data.file &&
              (g = b.viewHandler.parseUploadedFile(a.data.file)),
            (p = this.parseSurvey(g, s)),
            (g = p.message),
            (p = p.isSurvey),
            (f = new D(
              s,
            ...
            (f.template = l.escapeTemplateReplacement(n, [
              { placeholder: "__MESSAGE__", textReplace: g },
              { placeholder: "__NAME__", textReplace: a.name },
              { placeholder: "__IMAGE_URL__", textReplace: h },
              {
            ...
            c.isTopPositioned()
              ...
              : this.messagePreviewContainer.appendChild(f.elementReferrer),
            a.data &&
              a.data.file &&
              (f.elementReferrer.getElementsByClassName(
                "messageBody"
            ...
            a.ownerId &&
              ...
              (m += " hidden-profile"),
            (f.elementReferrer.className += m),
            f.elementReferrer.setAttribute("data-uid", a.ownerId),
            (d = f.elementReferrer.getElementsByClassName("messageTime")[0]),
            this.timeIntervalsArr.push({
              messageId: s,
              timeInterval: setInterval(function () {
            ...
            (this.prevSenderUid = a.ownerId),
            (g = f.elementReferrer.firstElementChild),
            b.eventHandler.listen(
              g,
              b.viewHandler.clickEvent,
              function () {
            ...
            (f.elementReferrer.className += " animate-fade-object")));
      };
      E.prototype.addSurveyHandlers = function (a) {
        var e,
          f = this;
        this.container &&
          ((e = this.container.getElementById(a)),
          (e = l.getElementsByTagName(e, "input")),
          e.forEach(function (e, c) {
            e.id &&
              f.container.attachUserEventListener(
                "click",
                function () {
                  f.lastRadioButton !== e.id &&
                    ((f.lastRadioButton = e.id),
      ...
      E.prototype.limitMessageLength = function (a, b) {
        ...
        if (a.length > b)
          for (f = 0; f < b; )
            if (
              '<img class="emojione"' === a.substring(f, f + 21) ||
              '<a target="_blank"' === a.substring(f, f + 18)
            )
      ...
      E.prototype.removeAllElements = function () {
        for (
          var a = null, b = 0, f = c.minimizedDimensions().width, n = 0;
          n < this.timeIntervalsArr.length;
          n++
        )
      ...
      E.prototype.removeElement = function (a) {
        ...
        f = this.messagePreviewContainer.getElementsByClassName(
          "message-preview-item"
        );
      ...
      E.prototype.initQuickReply = function () {
        if (!s.mobileBrowserName) {
          ...
          r.pageStatus() &&
            a &&
            ((a = l.rawDecode(c.onlineGreeting.actionMessage)),
            s.isPlaceholderSupported
            ...
            (e.innerHTML = b.languageParser.translate(
              "rollover",
              "uploadFile"
            )),
            this.container
      ...
      E.prototype.toggleActionsContentOnTyping = function (a) {
        ...
        a
          ? ((b.style.display = "block"), l.addClass(f, "additionalPadding"))
      ...
      E.prototype.toggleEmojiAction = function () {
        var a = this,
          ...
          f = this.container.documentRef.getElementById(
            "emoji-selection-container"
          ),
          n = this.container.getElementById("textareaContainer");
        c.showEmoji()
          ? ((b.style.display = "block"),
            l.addClass(n, "with-emoji"),
            (f.innerHTML = t.loader),
            this.container.attachUserEventListener(
              "click",
              function (b) {
                b.stopPropagation();
          ...
          : ((b.style.display = "none"), l.removeClass(n, "with-emoji"));
      };
        ...
        s.mobileBrowserName ||
          (this.resizeThrottle = setTimeout(function () {
            ...
            1 === c &&
              ...
              (d = a.chatTextarea.elementReferrer.scrollHeight);
            b && 20 <= d
              ? ((d = 150 < d ? 150 : d),
                a.isActionsContainerNotifShown
                  ? ((d += 52), (n.style.paddingBottom = "67px"))
                  : (n.style.paddingBottom = "15px"),
                (f.style.height = 50 + (d - 20) + "px"),
              ...
              : ((f.style.height = "50px"), (n.style.paddingBottom = "15px"));
          }, 100));
      };
      E.prototype.addEmojiToInput = function (a) {
        s.isPlaceholderSupported ||
          this.chatTextarea.elementReferrer.value !==
            l.rawDecode(c.onlineGreeting.actionMessage) ||
          (this.chatTextarea.elementReferrer.value = "");
        this.chatTextarea.elementReferrer.value += a;
      ...
      var y = TawkClass.extend({
        ...
        show: function () {
          ...
          b.eventHandler.listen(
            ...
            "hashchange",
            function () {
              (d.location && d.location.hash && "#" === d.location.hash) ||
                (b &&
                  b.visitorHandler &&
        ...
        appendAgent: function (a) {
          ...
          d &&
            ...
            (-1 <
              ...
              ((g.style.display = "none"), (e.className = "show")),
            b.agents.agentsCount++,
            1 < b.agents.agentsCount ||
            (1 === b.agents.agentsCount &&
              this.mainAgent &&
              this.mainAgent.pid !== a.pid)
              ? f.classList.remove("one-agent")
              : f.classList.add("one-agent"),
            1 === b.agents.agentsCount
              ? ((this.mainAgent = a),
                b.viewHandler.renderAgentHeader(a.pid),
                this.renderAgentMinimizedWidget(a.pid))
              : (b.viewHandler.renderAgentHeader(a.pid),
                n.classList.add("multiple-agent")),
            b.viewHandler.openAgentList(),
            (e = t["agent-profile"]),
            (f = t["agent-profile-image"]),
            (n = t["agent-profile-description"]),
            (d = new D(
              "agentProfile-" + a.pid,
              null,
            ...
            (h += "box-shadow: 0px 0px 0px 1px " + c.headerTxtColor + ";"),
            ...
            (d.template = l.escapeTemplateReplacement(e, [
              { placeholder: "__AGENT_PROFILE_DETAIL__", textReplace: n },
              { placeholder: "__AGENT_PROFILE_IMAGE__", textReplace: f },
              { placeholder: "__ID__", textReplace: "" },
            ])),
            k.appendChild(d.buildView()),
            (k.style.left = "50%"));
        },
        removeAgent: function (a) {
          var e,
            ...
            n,
            c,
            d = g.container.elementReferrer ? g.container : null,
            h = d.getElementById("chatWrapper");
          d &&
            (b.agents.agentsCount--,
            (e = d.getElementById("agentProfileContainer")),
            (f = d.getElementById("agentProfile-" + a)),
            (n = d.getElementById("profileImage-" + a)),
            (c = d.getElementById("profileDetail" + a)),
            ...
            0 < b.agents.agentsCount &&
              ...
              ((this.mainAgent =
                v.agentProfiles[Object.keys(v.agentProfiles)[0]]),
        ...
        clearAgentFooter: function () {
          ...
          a &&
            this.chatContainer &&
            ((f = a.getElementById("tawkchat-status-text-container")),
            (n = a.getElementById("min-agent-profile-details")),
        ...
        renderAgentMinimizedWidget: function (a) {
          ...
          s.mobileBrowserName &&
            this.minifiedWidget &&
            this.minifiedWidget.container &&
            (f = this.minifiedWidget.container);
          f &&
            this.chatContainer &&
            a &&
            ((e = v.agentProfiles[a]),
            (a = f.getElementById("tawkchat-status-agent-container")),
            (iconContainer = f.getElementById(
              "tawkchat-status-icon-container"
            )),
            (d = f.getElementById("agent-profile-image")),
            (tawkStatusMessage = f.getElementById(
              "tawkchat-status-text-container"
            )),
            (profileDetails = f.getElementById("min-agent-profile-details")),
            (n = f.getElementById("tawkchat-chat-indicator")),
            a &&
              (this.clearAgentFooter(),
              (f = e.pi ? r.agentImgUrl + "/" + e.pi : ""),
              (d.style.backgroundImage = f ? "url('" + f + "')" : ""),
              (d.style.boxShadow = "0px 0px 0px 1px " + c.headerTxtColor),
              (a.className += "appear"),
              profileDetails &&
        ...
        handleAcknowledgment: function (a) {
          ...
          if (m && a.messageId && (c = m.getElementById(a.messageId))) {
            ...
            for (var p = c.childNodes.length; f < p; f++) {
              var q = c.childNodes[f];
              -1 !== q.className.indexOf("messageBody") &&
                ((e = l.getElementsByClassName(q, "messageWrapper")),
                (k = l.getElementsByClassName(q, "messageStatusContainer")));
            }
            e &&
              e.length &&
              k &&
              ...
              a.error
                ? k &&
                  ...
                  (e.className = "messageWrapper error"),
                  (k.className = "messageStatusContainer errorInMessage"),
                  (k.innerHTML = n),
                  (d = l.rawDecode(
                    e.childNodes[0].textContent || e.childNodes[0].innerText
                  )),
                  this.scrollToBottom(),
                  (h = b.eventHandler.listen(
                    ...
                    function (f) {
                      ...
                      if ((g = m.getElementById("errorFor" + a.messageId)))
                        e.className = "messageWrapper pending";
                ...
                : ((f = b.chatHandler.messages[a.order]),
                  b.viewHandler.addWaitTime(),
                  n.removeChild(c),
                  b.chatHandler.prepareMessage(f, !0, !1, !0)));
          }
        },
        ...
        appendMessage: function (a) {
          ...
          b.chatHandler.noRedraw ||
            ...
            "v" === m ||
            "c" !== a.type ||
            (c.hideWidgetOnLoad && "max" === c.onClickAction
              ? ((b.viewHandler.userAction = !1),
                b.sessionHandler.notifyWindowState("max"))
              : b.viewHandler.messagePreview &&
          ...
          g = a.profileImg
            ? a.profileImg
              ? "https://tawk.link/" + a.profileImg
              : ""
            : (g = v.agentProfiles[a.ownerId]) && g.pi
            ? r.agentImgUrl + "/" + g.pi
            : "";
          ...
          "undefined" !== typeof G &&
            ((f = G.unifyUnicode(f)),
            0 === f.replace(G.regUnicode, "").trim().length &&
              (h += " emojionly"),
            (f = G.toImage(f)));
          1 >= v.chatOrder &&
            ((b.viewHandler.chatContainer.getElementById(
          ...
          "c" === a.type &&
            ((n = l.escapeTemplateReplacement(x["chat-message-row"], [
              {
            ...
            ? ((b.chatHandler.lastMessageOwner =
              ...
              "a" === m || "s" === m
                ? ("a" === m &&
                    ...
                    this.removeWaitTime()),
                  (f = l.escapeTemplateReplacement(
                    x["chat-message-owner-agent"],
                    [{ placeholder: "__NAME__", textReplace: a.name }]
                  )))
                : (f =
                    l.isGeneratedName(z.name()) &&
                    x["chat-message-owner-visitor"]
                      ? l.escapeTemplateReplacement(
                          x["chat-message-owner-visitor"],
                          [{ placeholder: "__NAME__", textReplace: a.name }]
                        )
                      : ""),
              (d = l.escapeTemplateReplacement(x["chat-message-container"], [
                { placeholder: "__OWNER_TPL__", textReplace: f },
                { placeholder: "__CONTENT__", textReplace: n },
              ])),
              a.data &&
                "v" === m &&
                (d = d.replace("messageBody", "messageBody file")),
              "s" === m &&
                ((d = d.replace(
                  "ownerNameContainer",
                  "ownerNameContainer trigger"
                )),
                (d = d.replace("messageBody", "messageBody trigger"))))
            : "n" === a.type &&
              ...
              a.isRtcError
                ? ((n =
                  ...
                  (d = l.escapeTemplateReplacement(t.noWebrtc, [
                    { placeholder: "__MESSAGE__", textReplace: f },
                    { placeholder: "__HEADER__", textReplace: n },
                  ])))
                : (d = l.escapeTemplateReplacement(
                    x["chat-notification-container"],
                    [
                      { placeholder: "__MESSAGE_ID__", textReplace: u },
                      { placeholder: "__MESSAGE__", textReplace: f },
                      { placeholder: "__TIME__", textReplace: k },
                    ]
                  )));
          h.template = d;
          h.buildView();
          ...
          if (a.timeStamp > r.lastMessageTimestamp)
            if ("v" === m) r.lastMessageTimestamp = a.timeStamp;
              ...
              !document.hidden &&
              l.chatElementInView(h.elementReferrer) &&
              b.viewHandler.isMaximized
            )
        ...
        updateViewByStatus: function (a) {
          ...
          "online" === a || "away" === a
            ? (c.showConsentForm
              ...
              this.showWidget(),
              p && (b.viewHandler.isMaximized || p.showBubble()))
            : "offline" === a &&
              (c.hideWidgetOnOffline
                ? this.hideWidget()
                : (b.formHandler.openForm(
                    c.showConsentForm ? "consentForm" : "offlineForm"
                  ),
                  this.showWidget()),
              p &&
                (p.hideBubble(),
      ...
      y.prototype.openAgentList = function () {
      ...
      y.prototype.addProfileDetail = function (a) {
        var e,
          f,
          c,
          d = this.chatContainer.getElementById("agentProfileContainer");
        a.pi || 1 < b.agents.agentsCount
          ? ((e = new D(
            ...
            (c = t["agent-profile-description"]),
            (e.template = l.escapeTemplateReplacement(c, [
              {
          ...
          : ((e = new D(
            ...
            (f = a.pst ? "&nbsp-&nbsp" + a.pst : ""),
            (c = t["agent-profile-description-noimage"]),
            (e.template = l.escapeTemplateReplacement(c, [
              { placeholder: "__POSITION__", textReplace: f },
              { placeholder: "__NAME__", textReplace: a.n },
            ])));
        ...
        d &&
          ...
          (f = e.pi ? r.agentImgUrl + "/" + e.pi : "") &&
            (n =
              ...
              ";"),
          (n += "box-shadow: 0px 0px 0px 1px " + c.headerTxtColor + ";"),
          (e = new D(
            "profileImage-" + e.pid,
            n,
        ...
        [].forEach.call(
          ...
          function (a) {
            ...
            e &&
              ...
              c &&
              (1 < b.agents.agentsCount &&
              d.offsetWidth < f.offsetWidth + e.offsetWidth
                ? ((c.style.left = 45 + e.offsetWidth + "px"),
                  (c.style.right = "auto"))
                : ((c.style.right = "0"), (c.style.left = "auto")));
          }
        );
      };
      ...
      y.prototype.begin = function () {};
      y.prototype.getViewportDimensions = function (a) {
        var b,
          f = {};
        a
          ? ((a = d), (b = document))
          : ((a = g.container.elementReferrer), (b = g.container.documentRef));
        if ("undefined" !== typeof a.innerWidth)
          return (f.height = a.innerHeight), (f.width = a.innerWidth), f;
        if (
          ...
          return (
            (f.height = b.documentElement.clientHeight),
            (f.width = b.documentElement.clientWidth),
            f
          );
      ...
      y.prototype.addSurveyHandlers = function (a) {
        var e,
          f = this;
        this.chatContainer &&
          ((e = this.chatContainer.getElementById(a)),
          (e = l.getElementsByTagName(e, "input")),
          e.forEach(function (e, c) {
            e.id &&
              f.chatContainer.attachUserEventListener(
                "click",
                function () {
                  f.lastRadioButton !== e.id &&
                    ((f.lastRadioButton = e.id),
        ...
        if (a && f) {
          if (b.formHandler.currentForm)
            return (
              ...
              (e = a.offsetHeight + 10),
              (a = 30 > a.scrollHeight - (a.scrollTop + e)),
      ...
      y.prototype.isChatScrollbar = function () {
        ...
        if (
          ...
          return (
            a.scrollHeight > this.getViewportDimensions(c.isPopup).height - 139
          );
      };
      y.prototype.addWaitTime = function () {
        ...
        !b.chatHandler.agentHasMessaged &&
          c.showWaitTime &&
          ((e = this.chatContainer.getElementById("greetingsContent")),
          (a = this.chatContainer.getElementById("greetingsWaitTime")) &&
            e &&
            ((f = Math.ceil(r.waitTime / 6e4)),
            (f = b.languageParser.translate("chat", "messageQueuedText", {
              t: f,
              strongStart: "<b>",
              strongEnd: "</b>",
            })),
      ...
      y.prototype.removeWaitTime = function () {
        var a, b;
        this.chatContainer &&
          this.chatContainer.elementReferrer &&
          ((a = this.chatContainer.getElementById("greetingsWaitTime")),
          ...
          a &&
            ...
            ((a.innerHTML = ""),
            (a.style.display = "none"),
            l.hasClass(b, "no-content") && (b.style.display = "none")));
      };
      y.prototype.waitTimeUpdater = function (a) {
        ...
        if (
          this.chatContainer &&
          this.chatContainer.elementReferrer &&
          (f = this.chatContainer.getElementById("greetingsWaitTime")) &&
          !(6e4 >= r.waitTime)
        ) {
          e = r.waitTime % 6e4 || 6e4;
          if (a)
      ...
      y.prototype.appendAgentIsTypingElement = function (a) {
        var b,
          ...
          d = v.agentProfiles[a];
        this.chatContainer &&
          ((f = d && d.pi ? r.agentImgUrl + "/" + d.pi : ""),
          (d.strongStart = "<b>"),
          (d.strongEnd = "</b>"),
          (b = t["agent-typing"]),
          (b = l.escapeTemplateReplacement(b, [
            { placeholder: "__MESSAGE_ID__", textReplace: a },
            { placeholder: /__NAME__/gm, textReplace: d.n },
            {
      ...
      y.prototype.changeRating = function (a) {
        ...
        this.chatContainer &&
          (0 > a
            ? (a =
                c.showEmoji() && "undefined" !== typeof G
                  ? ":thumbsdown_tone2:"
                  : "&#128078;")
            : 0 < a
            ? (a =
        ...
        d &&
          ...
          ((c = l.escapeTemplateReplacement(t.departmentOfflineNotification, [
            ...
            },
            {
              ...
              textReplace: b.languageParser.translate(
                "chat",
                "offline" === e ? "departmentIsOffline" : "departmentIsAway",
      ...
      y.prototype.setDivider = function (a, e, f) {
        ...
        !this.chatContainer.documentRef.getElementById("newMessageDivider") &&
          ...
          d.buildView(),
          g.insertBefore(d.elementReferrer, f.elementReferrer),
          !l.chatElementInView(d.elementReferrer) &&
            (b.viewHandler.isMaximized || c.isPopup || c.isEmbedded) &&
            (n = this.chatContainer.documentRef.getElementById(
              "newMessagesBar"
            ))) &&
          ((n.className = "visible"),
          b.eventHandler.listen(
      ...
      y.prototype.checkUnseenMessages = function () {
        ...
        for (var b = 0; b < this.unseenMessages.length; b++)
          l.chatElementInView(this.unseenMessages[b]) &&
            (this.unseenMessages.splice(b, 1), b--);
        if (
          !this.unseenMessages.length ||
          (s.mobileBrowserName && this.ifScrollbarDown())
        )
          (this.newMessageNotSeen = !1),
            (a = this.chatContainer.documentRef.getElementById(
              "newMessagesBar"
      ...
      y.prototype.parseUploadedFile = function (a) {
          ...
          h.onload = function () {
            ...
            if (n) {
              ...
              if (!b.viewHandler.isMaximized && f.messagePreview) {
                k = l.createElement(
                  f.messagePreview.container.documentRef,
                  "a",
                  { href: e, target: "_blank" }
                );
                if (
                  (m = f.messagePreview.container.getElementById(
                    "placeholder-" + a.name
                  ))
                )
                  k.appendChild(h),
        ...
        return (c = l.escapeTemplateReplacement(c, [
          ...
          { placeholder: "__DOWNLOAD_URL__", textReplace: e },
          {
          ...
          f.handle
            ? ((k = f.handle),
              (g = l.escapeTemplateReplacement(g, [
                { placeholder: "__HANDLE__", textReplace: k },
                { placeholder: "__FILE_NAME__", textReplace: l.rawEncode(e) },
                {
                  placeholder: "__FILE_STATUS__",
                  textReplace: b.languageParser.translate("chat", "uploading"),
                },
              ])),
              (d.chatContainer.getElementById("chatWrapper").innerHTML += g),
              h && d.scrollToBottom(),
              b.fileUploadHandler.uploadFile(k, a, e, function (b, f) {
                c.value = "";
      ...
      y.prototype.checkUploadFileWarning = function (a, e) {
        var f = this.chatContainer.getElementById(
        ...
        if (e.length) {
          ...
          for (var m = 0; m < e.length; m++)
            (this.retryUploadList["retry_upload_" + m] = e[m]),
              (k +=
                "<li>" +
                e[m].name +
                ' <a id="retry_upload_' +
          ...
          for (g = 0; g < k.length; g++)
            k[g].addEventListener(h.clickEvent, function () {
      ...
      y.prototype.applyWhiteLabelSettings = function () {
        ...
        this.chatContainer &&
          ...
          c.whiteLabel()
            ? ((f.url = c.whiteLabel().url || null),
              (f.label =
                l.transformLabel(l.rawEncode(c.whiteLabel().label)) || null),
              (f.textColor = c.whiteLabel().textColor || "#000000"))
            : ((f.url = "#"), (f.label = t["default-branding"])),
          null === f.label
            ? ((a = this.chatContainer.documentRef.getElementById(
                "contentContainer"
              )),
            ...
            : (l.insertRandomTagsBeforeAndAfter(b, b.parentNode, "div"),
              l.insertRandomTagsBeforeAndAfter(a, a.parentNode, "a"),
              l.applyWhiteLabelSettings(a, f)));
      };
      y.prototype.showCallRequest = function (a, e, f, n) {
        ...
        g ||
          ...
          b.chatHandler.webrtcWin && !b.chatHandler.webrtcWin.closed
            ? b.chatHandler.webrtcWin.focus()
            : ((g =
                (n = v.agentProfiles[v.profiles[n.urid]]) && n.pi
                  ? r.agentImgUrl + "/" + n.pi
                  : "default"),
              (d = d.replace(
                /__IMAGE_URL__/,
              ...
              (g = new D("incoming-call")),
              (g.template = d),
              g.buildView(),
              (d = this.chatContainer.getElementById("chatContainer")),
              (n = d.parentNode),
              d &&
                n &&
                (n.insertBefore(g.elementReferrer, d),
                (d = this.chatContainer.getElementById("accept-call")),
                (n = this.chatContainer.getElementById("decline-call")),
      ...
      y.prototype.subscribeCallUpdate = function (a, e) {
        ...
        r
          ...
          : ((f = new D(
            ...
            (f.template = l.escapeTemplateReplacement(t.callInfo, [
            ...
            q
              ...
              .insertBefore(
                f.elementReferrer,
                q.getElementById("agentTypingContainer")
              ),
        ...
        b.socketManager.sendToConnector(
          ...
          function (q, r) {
            ...
            q
              ? (d && d.length && (d[0].style.display = "none"),
                h && h.length
                  ...
                  : ((m = t.callError
                    ...
                    (h = l.createElement(
                      p.chatContainer.documentRef,
                      "div",
                      null,
                      null,
                      m
                    )),
                    (h.className = "callErrorContainer"),
                    (h.style.display = "block"),
                    f.elementReferrer.appendChild(h)),
                (k = l.getElementsByClassName(
                  f.elementReferrer,
                  "retry-load"
                )) &&
                  k.length &&
              ...
              : r.data.call.f &&
                ...
                g && g.length && (g[0].innerHTML = callIcon),
                (p.callData[a].ver = r.data.call.ver),
                s && p.scrollToBottom(),
                p.updateCallView(r.data.call, e));
          }
        );
      };
      y.prototype.updateCallView = function (a, e) {
        ...
        c.ver > a.ver ||
          ((h = this.ifScrollbarDown()),
          (c = c.callView),
          (m = c.elementReferrer.getElementsByClassName("btn-icon")[0]),
          (callIconContainerEl = c.elementReferrer.getElementsByClassName(
            "callIconContainer"
          )[0]),
          ...
          "ringing" === a.stts
            ...
            : "in-progress" === a.stts
            ? (this.removeCallRequest(),
              (f = b.languageParser.translate("chat", "ongoing_call")))
            : "completed" === a.stts &&
              ((g = l.parseChatTime(a.so)),
              this.removeCallRequest(),
              ...
              k || d
                ? ((f = d
                  ...
                  (d = b.languageParser.translate("chat", "call_started_on", {
                    startedOn: g,
                  })))
                : ((d = l.getTimeDifference(a.so, a.eo)),
                  (f = b.languageParser.translate("chat", "completed_call")),
                  (d = b.languageParser.translate("chat", "call_end_details", {
                    startedOn: g,
                    duration: d,
                  }))),
              (g = l.getElementsByClassName(
                c.elementReferrer,
                "callEndDetails"
              )) &&
                g.length &&
                ((g[0].innerHTML = d), (g[0].style.display = "block"))),
          (c = l.getElementsByClassName(c.elementReferrer, "callTitle")) &&
            c.length &&
            ((c[0].innerHTML = f), k && (c[0].className += " missed")),
      ...
      y.prototype.toggleGreetingsView = function (a) {
        ...
        a || c === d || 5 >= c - d
          ? 0 === e.scrollTop &&
            -1 !== f.className.indexOf("minimize") &&
            ((f.className = f.className.replace(" minimize", "")),
            (this.chatContainer.getElementById(
      ...
      y.prototype.checkSeenMessageViewport = function () {
        ...
        if (0 !== this.unseenMessages.length) {
          for (var c = 0; c < this.unseenMessages.length; c++) {
            ...
            d &&
              l.chatElementInView(d) &&
              (e = b.chatHandler.getMessageObjectById(f));
          ...
          -1 !== a &&
            (f = this.unseenMessages[this.unseenMessages.length - 1]) &&
            (e = b.chatHandler.getMessageObjectById(f)) &&
            this.updateLastTimestamp(e.timeStamp);
        }
      };
      ...
      var J = function () {
        ...
        this.forms = {
          ...
          preChatForm: {
            id: "preChatForm",
            getTitle: function () {
              return c.prechatOptions.text
                ? l.transformGreetings(c.prechatOptions.text)
                : c.isEmbedded &&
                  "page" === $_Tawk_WidgetId &&
                  pageType &&
                  "profile" === pageType
          ...
          consentForm: {
            ...
            getTitle: function () {
              return l
                .transformGreetings(c.consentOption.text)
                .replace(l.regLineBreaks, l.br);
            },
            dynamicFields: null,
            dontCloseForm: !0,
            otherEvent: {
      ...
      J.prototype.openForm = function (a) {
        ...
        if (m && this.currentForm !== a && k) {
          ...
          "consentForm" !== a &&
          this.forms[a].getTitle()
            ? ((e.innerHTML = this.forms[a].getTitle()),
          ...
          b.viewHandler.chatContainer.attachUserEventListener(
            ...
            function (a) {
              ...
              b || e === d || 5 >= e - d
                ? 0 === f.scrollTop &&
                  -1 !== c.className.indexOf("minimize") &&
                  (c.className = c.className.replace(" minimize", ""))
                : -1 === c.className.indexOf("minimize") &&
        ...
        if (!(s.mobileBrowserName || c.isPopup || c.isEmbedded))
          if (!b.formHandler.currentForm || a)
            b.viewHandler.chatContainer.restyle(
              "height",
              c.maximizedDimensions().height + "px !important"
            );
          else {
            ...
            "block" ===
              b.viewHandler.chatContainer.getElementById("overlayOfflineForm")
                .style.display
              ? (e = b.viewHandler.chatContainer.getElementById("offlineForm"))
              : l.getElementsByClassName(e, "formFrame")
              ? (e = l.getElementsByClassName(e, "formFrame")[0])
              : ((e = l.getElementsByClassName(e, "formTable")[0]), (f = 60));
            a && (f += a.offsetHeight);
            a = e.offsetHeight + f;
            a >= c.maximizedDimensions().height &&
              (a = c.maximizedDimensions().height);
      ...
      J.prototype.resize = function () {
        ...
        null !== this.formView &&
          ...
          (f = b.viewHandler.chatContainer.getElementById("formInnerHeight")),
          (d = b.viewHandler.chatContainer.getElementById("headerBoxWrapper")),
          c &&
            ((a = l.getElementsByClassName(c, "formMessageField")),
            (e = l.getElementsByClassName(c, "longFormContainer")),
            a &&
              a.length &&
              e &&
              e.length &&
              ((a = l.getElementsByClassName(c, "longFormBottomContainer")[0]
                .clientHeight),
              (e[0].style.height =
            ...
            !f ||
              ...
              b.viewHandler.addOverflowScroll(f))));
      };
      J.prototype.closeForm = function () {
        ...
        if (this.currentForm || d)
          e && (e.className = e.className.replace(/form-opened/g, "")),
            a &&
              this.formView &&
              ((this.formView = null),
              (this.currentForm = ""),
              ...
              (e = b.viewHandler.chatContainer.getElementById("greetingsText")),
              a && ((a.style.display = "block"), (e.innerHTML = "")),
              f && ((f.className = ""), (f.innerHTML = "")),
      ...
      J.prototype.attachEventListeners = function () {
        ...
        m
          ? ((d = b.viewHandler.chatContainer.getElementById("formCancel")),
            (h = b.viewHandler.chatContainer.getElementById("formSubmit")),
            (q = "formcancelclick-pc"),
            (r = "formsubmitclick-pc"))
          : p &&
            ((h = b.viewHandler.chatContainer.getElementById("formSubmit")),
            (a = b.viewHandler.chatContainer.getElementById("resendButton")),
            (r = "formsubmitclick-ol"));
            ...
            function (a) {
              if (m)
                return b.eventEmitter.emit(
                  f.formView.formData.saveFunc,
                  {},
                  function (a, b) {
                    f.handleAfterSave(a, { serverData: b });
                  }
                );
              f.closeForm();
              b.eventHandler.cancelEvent(a);
        ...
        l.forEach(function (a) {
          if (!a.disabled) {
            var e = b.viewHandler.chatContainer.getElementById(
                a.fieldName + "Field"
              ),
              c = b.viewHandler.chatContainer.getElementById(
                a.fieldName + "FieldError"
              ),
              d = b.viewHandler.chatContainer.getElementById(
        ...
        if (c.otherEvent) {
          var s = c.otherEvent;
          (a = b.viewHandler.chatContainer.getElementById(s.elementName)) &&
            b.eventHandler.listen(
              a,
              s.eventName,
              function () {
      ...
      J.prototype.updateFormStatus = function (a) {
        ...
        b.viewHandler.chatContainer &&
          ((e = b.viewHandler.chatContainer.getElementById("formSavingStatus")),
          (f = b.viewHandler.chatContainer.getElementById("savingStatus")),
          (c = b.viewHandler.chatContainer.getElementById("submitWrapper")),
          e && f
            ? a
              ? ((e.className = "errorMessage"),
                (f.innerHTML = b.languageParser.translate(
                  "form",
                  "errorSaving"
                )),
                (a = l.getElementsByClassName(
                  b.viewHandler.chatContainer.documentRef,
                  "longFormContainer"
                )),
                a.length && (a[0].scrollTop = 999999999999))
              : ((e.className = ""),
                (f.innerHTML = b.languageParser.translate("form", "saved")))
          ...
          return (
            ...
            a.forEach(function (a) {
              ...
              if (
                ...
                a.getValue &&
                l.isArray(a.getValue())
              )
                (f.additionalQuestion = {}),
                  a.getValue().forEach(function (e, c) {
                    (h = b.viewHandler.chatContainer.getElementById(
                      a.fieldName + c
                    )) &&
                      (f.additionalQuestion[c] =
                        e === h.value ? null : l.trim(h.value));
                  });
              else if ("choice" === a.fieldType || "option" === a.fieldType)
                (p = b.viewHandler.chatContainer.documentRef.getElementsByName(
                  a.fieldName + "group"
                )),
                  ...
                  (formLabelEl = g.parentElement.parentElement.getElementsByClassName(
                    "form-field-label"
                  )[0]),
                  ...
                  (p =
                    "choice" === a.fieldType
                      ? d.getSelectedCheckbox(p, a.isRequired)
                      : d.getSelectedRadio(p, a.isRequired)),
                  (k.innerHTML = ""),
                  (k.style.display = "none"),
                  (errorIconEl.style.display = "none"),
                  (g.className = g.className.replace("error", "")),
                  null === p
                    ? (c++,
                      (m = !1),
                      (k.innerHTML = b.languageParser.translate(
                        "form",
                ...
                k.style.display = "none";
                errorIconEl.style.display = "none";
                h.parentNode.className = h.parentNode.className.replace(
                  "error",
                  ""
                );
                m
      ...
      J.prototype.isValidString = function (a, b, f) {
        return f || a
          ? !(!a || !l.isString(a) || (b && !(b && a.length <= b)))
          : !0;
      };
      J.prototype.isValidEmail = function (a, b, f) {
        return f || a
          ? !!(a && l.isEmail(a) && l.isString(a) && a.length <= b)
          : !0;
      };
        ...
        a.forEach(function (a, f) {
          ...
          if (
            ...
            if ("choice" === a.fieldType || "option" === a.fieldType) {
              c = b.viewHandler.chatContainer.documentRef.getElementsByName(
                a.fieldName + "group"
              );
      ...
      var K = TawkClass.extend({
        init: function () {
          ...
          c.isCenterPositioned()
            ? (this.messagePreviewHeight =
                ...
                0.5 * c.minimizedDimensions().width +
                20 -
            ...
            : (this.messagePreviewHeight =
                ...
                (c.minimizedDimensions().height + this.offsetY) -
                this.messagePreviewOffset +
                "px");
          this.messagePreview = new N(
            l.getRandomName(),
            l.getGenericStyle({
              zindex: "999999",
              width: "378px",
        ...
        buildView: function () {
          ...
          if (
            ...
            this.chatIndicator.buildIframe(b.MinifiedStyle + c.minStyle(), !0),
            (a = l.getElementsByTagName(
              this.chatIndicator.documentRef,
              "body"
            )[0]),
            (a.innerHTML = t["tawkchat-chat-indicator"]),
            this.container.buildIframe(b.MinifiedStyle + c.minStyle()),
            this.bubbleContainer &&
              (c.chatBubble() && this.bubbleContainer.elementReferrer
                ? this.bubbleContainer.buildIframe(
                    b.MinifiedStyle + c.minStyle(),
                    !0
                  )
      ...
      K.prototype.updateStatus = function (a) {
        ...
        a || (a = r.pageStatus());
        if (this.container && a) {
          if ((e = this.container.getElementById("tawkchat-status-icon")))
            e.className = a;
          if ((e = this.container.getElementById("tawk-minified-mobile-text")))
            e.innerHTML =
              "online" === a || "away" === a
      ...
      K.prototype.widgetDimensionsUpdated = function () {
        this.container &&
          (c.isDesktopRectangle()
            ? ((minWidth = c.minimizedDimensions().width),
              (minHeight = c.minimizedDimensions().height))
          ...
          this.container.massRestyle({
            ...
            "border-radius": c.isDesktopRectangle()
              ? "0 !important"
              : "50% !important",
          }),
      ...
      K.prototype.bubbleSettingsChanged = function () {
        var a = c.chatBubble();
        if ((!a && this.bubbleContainer) || c.hideWidgetOnLoad)
              ...
              (this.bubbleContainer.elementReferrer &&
                this.bubbleContainer.insertCssFile(
                  ".bubble-text-color{color:" +
                    (c.chatBubble() ? c.chatBubble().fgc : "#ffffff") +
                    ";}",
                  !0
                )),
            a &&
      ...
      K.prototype.widgetPositonChanged = function () {
        ...
        c.isCenterPositioned()
          ? (c.isDesktopRectangle() &&
              (d =
                0.5 * c.minimizedDimensions().height -
                0.5 * c.minimizedDimensions().width +
                "px"),
            c.isRightPositioned()
              ? ((bodyClassName = "center right"),
                (a = c.isDesktopRectangle()
                  ? l.getRotateStyling("-90", "49%")
                  : l.getRotateStyling("0", "0")),
                (a.right = d),
                (a.left = "auto !important"))
              : ((bodyClassName = "center left"),
                ...
                (a.left = d),
                (a.right = "auto !important")),
            c.isDesktopRectangle() || (a.transform = "unset"),
            (a.top =
              "calc(50% - " +
              0.5 * c.minimizedDimensions().height +
              "px) !important"),
            (a.bottom = "auto !important"))
          : ((a = l.getRotateStyling("0", "0")),
            (a.margin = "0px !important"),
            c.isTopPositioned()
              ? ((a.top = f + "px !important"),
                (a.bottom = "auto !important"),
                (bodyClassName = " top "))
              : ((a.top = "auto !important"),
                (a.bottom = f + "px !important"),
      ...
      K.prototype.createBubble = function () {
        ...
        this.bubbleContainer &&
          ...
          c.chatBubble &&
          !r.chatBubbleClosed() &&
          (c.chatBubble().type && "default" !== c.chatBubble().type
      ...
      K.prototype.calculateBubblePositioning = function (a, b, f, d, g, h, k) {
        ...
        if (c.isCenterPositioned()) {
          ...
          r = d;
          0 === h
            ? ((m = "gallery" === c.chatBubble().type ? 0 : 0.5 * (m - b)),
              (f += "px !important"))
            : "gallery" === c.chatBubble().type
            ? ((r = m = 0), (f = -1 * (0.5 * (a - b) - d) + "px !important"))
            : ((m = 0.5 * (m - a)),
              (f = -1 * (0.5 * (a - b) - f) + "px !important"));
          p = l.getRotateStyling(h, "49%");
          c.isRightPositioned()
            ? ((p.right = f), (p.left = "auto !important"))
            : ((p.left = f), (p.right = "auto !important"));
          p.top = "50% !important";
          p.bottom = "auto !important";
          h = q - m + r;
        } else
          (p = l.getRotateStyling("0", "0")),
            (h = "0"),
            c.isTopPositioned()
              ? ((p.top = d + "px !important"),
                (p.bottom = "auto !important"),
                (k += " top "))
              : ((p.bottom = d + "px !important"),
                (p.top = "auto !important"),
                (k += " bottom ")),
            c.isRightPositioned()
              ? ((p.right = f + "px !important"),
                (p.left = "auto !important"),
                (k += " right "))
              : ((p.left = f + "px !important"),
                (p.right = "auto !important"),
                (k += " left "));
      ...
      K.prototype.createDefaultBubble = function () {
        ...
        if (a || b)
          (b = l.getElementsByTagName(
            ...
            (a.innerHTML = c.chatBubble().txt),
            (a.style.color = c.chatBubble().fgc),
            c.isCenterPositioned()
              ? (c.isRightPositioned()
                  ? ((f = -90),
                    (d -= 10),
                    c.isRTL() && (d = c.minimizedDimensions().width - 146))
                  : ((f = 90),
                    (d = c.isDesktopRectangle()
                      ? c.minimizedDimensions().width - 146 + 10
                      : 10),
                    c.isRTL() && (d = 0)),
                (a = c.minimizedDimensions().height + this.offsetX + 2))
              : ((d = c.minimizedDimensions().height + this.offsetY + 2),
                (a =
                  (!c.isRightPositioned() && !c.isRTL()) ||
                  (c.isRightPositioned() && c.isRTL())
                    ? c.isDesktopRectangle()
                      ? c.minimizedDimensions().width - 146 + 16
                      : 10
                    : 0)),
            c.isRTL() && (g += " rtl-direction"),
            this.calculateBubblePositioning(146, 85, a, d, 0, f, g);
      };
      K.prototype.createImageBubble = function () {
        ...
        var g = c.chatBubble(),
          ...
          k = 0;
        "gallery" === g.type
          ? ((b = parseInt(g.name, 10)),
            (d = 22 === b),
            c.isDesktopRectangle() || (b += "-r"),
            c.isCenterPositioned()
              ? ((b += c.isRightPositioned() ? "-cr" : "-cl"),
                c.isDesktopRectangle())
              : (b = c.isTopPositioned()
                  ? b + (c.isRightPositioned() ? "-tr" : "-tl")
                  : b + (c.isRightPositioned() ? "-br" : "-bl")),
            (a = " gallery "),
            (b =
              "https://static-v.tawk.to/a-v3/images/bubbles/" +
              b +
              (d ? ".png" : ".svg")),
            c.isCenterPositioned() && 0 === g.rotate && (a += " center-right"),
            (f.innerHTML = l.escapeTemplateReplacement(
          ...
          : ((a = " upload "),
            (b = "https://tawk.link/" + c.chatBubble().name),
            (f.innerHTML = l.escapeTemplateReplacement(
        ...
        c.isTopPositioned() || c.isCenterPositioned()
          ? ((k += g.topOffset),
            c.isCenterPositioned() && 0 === g.rotate && (k -= 16))
          : (k += g.bottomOffset);
        f = c.isRightPositioned() ? g.rightOffset : g.leftOffset;
        c.isCenterPositioned() &&
          0 !== g.rotate &&
          (f = "gallery" === g.type ? f - 3 : f + 2);
        ...
        c.hideWidget ||
          ...
          b.type && "default" !== b.type
            ? ((d = b.topOffset),
              ...
              (h = c.isRightPositioned() ? b.rightOffset : b.leftOffset))
            : ((bubbleWidth = 146),
              (bubbleContainerHeight = 85),
              c.isCenterPositioned()
                ? ((h = minHeight + 2), (l = c.isRightPositioned() ? -90 : 90))
                : ((d = minHeight + 2),
                  (g = minHeight + 2),
                  (h = c.isRightPositioned()
                    ? 0
                    : minWidth - bubbleWidth + closeIconWidth))),
          c.isCenterPositioned()
            ? ((d = -0.5 * minWidth + 0.5 * a + "px !important"),
              (h += f),
              (f =
                0 === l
                  ? h + "px !important"
                  : -1 * (0.5 * (bubbleWidth - bubbleContainerHeight) - h) +
                    "px !important"),
              c.isRightPositioned()
                ? (this.container.restyle("right", d),
                  (m.right = f),
                  k &&
                    (this.container.restyle(
                      "right",
                    ...
                    0 !== l &&
                      (m.right =
                        ...
                        "px !important")))
                : c.isCenterPositioned() ||
                  (this.container.restyle("left", d),
                  (m.left = f),
                  k &&
                    (this.container.restyle("left", "0px !important"),
                    0 !== b.rotate && (m.left = h + "px !important"))),
              k
                ? this.container.restyle(
                    "margin",
            ...
            : c.isCenterPositioned() ||
              (c.isTopPositioned()
                ? (m.top = d + f + "px !important")
                : (m.bottom = g + f + "px !important")),
          this.bubbleContainer &&
            this.bubbleContainer.elementReferrer &&
            c.chatBubble &&
            !r.chatBubbleClosed() &&
      ...
      K.prototype.calculateIndicatorPositioning = function () {
        ...
        c.isCenterPositioned()
          ? (c.isRightPositioned()
              ? ((a.right = m + h - f + 5 + "px !important"),
                (a.top = "calc(50% - " + 0.5 * g + "px) !important"),
                (a.left = "auto !important"),
                (p = "right"),
                (a.bottom = "auto !important"),
                c.isDesktopRectangle()
                  ? ((a.right = m + h - f + 5 + "px !important"),
                    c.isRTL() &&
                      ((a.bottom =
                        "calc(50% - " + (0.5 * g + 5) + "px) !important"),
                      (a.top = "auto !important")))
                  : (c.isRTL()
                      ? (a.right = h + "px !important")
              ...
              : ((a.right = "auto !important"),
                ...
                (a.bottom = "auto !important"),
                c.isDesktopRectangle()
                  ? ((a.top = "calc(50% - " + (0.5 * g + 5) + "px) !important"),
                    (a.left = m + h - f + 5 + "px !important"),
                    c.isRTL() ||
                      (a.top =
                        "calc(50% + " + (0.5 * g - 0.5 * f) + "px) !important"))
                  : ((a.top = "calc(50% - " + 0.5 * g + "px) !important"),
                    c.isRTL()
                      ? (a.left = l - 5 + "px !important")
                      : (a.left = l + g - b + 5 + "px !important"),
                    (a.right = "auto !important"))),
            (k += " bottom " + p))
          : (c.isTopPositioned()
              ? ((k += " top "),
              ...
              : ((k += " bottom "),
                (a.top = "auto !important"),
                c.isDesktopRectangle()
                  ? (a.bottom = h - l - 5 + "px !important")
                  : (a.bottom = h + m - c.widgetOffsetY + "px !important")),
            c.isRightPositioned()
              ? ((k += " right "),
                c.isRTL()
                  ? c.isDesktopRectangle()
                    ? (a.right = g - 5 + "px !important")
                    : (a.right = g + "px !important")
                  : c.isDesktopRectangle()
        ...
        createCanvasChatBubble: function () {
          ...
          if (
            ...
            c.chatPosition(),
              ...
              g.lineTo(68, x),
              g.lineTo(u + 134 - 8, x),
              g.quadraticCurveTo(u + 134, x, u + 134, x + 8),
              g.lineTo(u + 134, x + 63 - 8),
              g.quadraticCurveTo(u + 134, x + 63, u + 134 - 8, x + 63),
              g.lineTo(u + 8, x + 63),
              g.quadraticCurveTo(u, x + 63, u, x + 63 - 8),
              g.lineTo(u, x + 8),
              g.quadraticCurveTo(u, x, u + 8, x),
              (g.strokeStyle = "#e3e0e7"),
              (g.lineWidth = 2),
              g.stroke(),
              g.closePath(),
              g.fill(),
              g.beginPath(),
              g.arc(68, s, 10, Math.PI * a, Math.PI * b, v),
              (g.strokeStyle = "#e3e0e7"),
              (g.lineWidth = 2),
              g.stroke(),
              g.fill(),
              c.isDesktopRectangle() ||
                (c.isTopPositioned() && c.isLeftPositioned()
                  ? (r -= 30)
                  : c.isBottomPositioned() && c.isRightPositioned()
                  ? (r += 30)
                  : c.isCenterPositioned() &&
                    c.isRightPositioned() &&
                    (r += 30)),
              g.beginPath(),
              g.arc(r, t, 5, 0, 2 * Math.PI, !1),
              (g.strokeStyle = "#e3e0e7"),
              (g.lineWidth = 2),
              g.stroke(),
              g.closePath(),
              g.fill(),
              g.beginPath(),
              g.arc(k, h + 5, 10, Math.PI * f, Math.PI * d, w),
              (g.strokeStyle = "#e3e0e7"),
              (g.lineWidth = 2),
              g.stroke(),
              g.closePath(),
              ...
              g.closePath(),
              (g.lineWidth = 2),
              (g.strokeStyle = c.chatBubble().fgc),
              g.stroke(),
              g.beginPath(),
              g.moveTo(p, h + 1.5),
              g.lineTo(q, h + 8),
      ...
      Aa.prototype.addClassName = function () {
        ...
        this.container &&
          ...
          (this.container.getElementById(
            "tawkchat-minified-wrapper"
          ).className = l.getContrast(c.headerTxtColor) + a);
        this.chatIndicator &&
      ...
      var S = TawkClass.extend({
        init: function (a, e) {
          ...
          this.frameWidth = s.mobileBrowserName
            ? "100%"
            : c.maximizedDimensions().width + "px";
          this.frameHeight = s.mobileBrowserName
            ? "100%"
            : c.maximizedDimensions().height + "px";
          this.isActionsContainerNotifShown = this.isChatMenuOpen = !1;
          this.resizeThrottle = 0;
          this.container = c.isPopup
            ? new D(l.getRandomName(), "display: none;")
            : new N(
                l.getRandomName(),
                l.getGenericStyle({
                  zindex: "999999",
          ...
          c.maximizedDimensions.subscribe(function (a) {
            c.isEmbedded ||
              c.isPopup ||
              s.mobileBrowserName ||
              ((f.frameHeight = a.height + "px"),
              (f.frameWidth = a.width + "px"),
              f.container.restyle("height", f.frameHeight + " !important"),
              f.container.restyle("width", f.frameWidth + " !important"));
          });
          ...
          c.desktopWidget.subscribe(function () {
            c.isDesktopRectangle()
              ? (f.wrapper.removeClass("roundWidget"),
                (f.container.documentRef.getElementById(
                  "minimizeChat"
                ).className = "headerBoxLink"),
                "br" === c.chatPosition()
                  ? (f.container.documentRef.body.className = "right")
                  : (f.container.documentRef.body.className = "left"))
              : (f.wrapper.addClass("roundWidget"),
                (f.container.documentRef.getElementById(
                  "minimizeChat"
                ).className = "notShown"));
          });
        ...
        buildView: function () {
          c.isPopup ||
            this.container.buildIframe(b.MaximizedStyle + c.maxStyle());
          this.container.documentRef
            .getElementById("textareaContainer")
            .appendChild(
              this.chatTextarea.buildView(this.container.documentRef)
            );
          c.isEmbedded || c.isPopup || s.mobileBrowserName
            ? this.restyleEmbed()
            : "br" == c.chatPosition()
            ? (l.removeClass(this.container.documentRef.body, "left"),
              l.addClass(this.container.documentRef.body, "right"))
            : (l.removeClass(this.container.documentRef.body, "right"),
              l.addClass(this.container.documentRef.body, "left"));
          this.addClassName();
          this.updateGreetings();
          this.toggleSound();
          this.attachEvents();
          ...
          c.isEmbedded || !c.isDesktopRectangle() || c.isPopup
                    ...
                    if (
                      ...
                      for (var d = 0; d < e.length; d++)
                        if (-1 !== e[d].type.indexOf("image")) {
                          ...
                          if (null !== g) {
                            c = g;
                            c.name = b.languageParser.translate(
                              "chat",
                              "pasted_image_title",
                              { dateTime: l.parseChatTime(new Date()) }
                            );
                ...
                function (e) {
                  ...
                  d &&
                    ("function" === typeof d.contains
                      ? d.contains(e) || a.closeEmojiSelection()
                      : l.isDescendent(d, e) && a.closeEmojiSelection());
                },
                null,
                "maxWidgetClick"
              ))
            : ((f.style.display = "none"), l.removeClass(e, "with-emoji"));
        },
        attachEvents: function () {
          var a = this,
            e = this.container.documentRef.getElementById(
          ...
          if (s.mobileBrowserName) {
            ...
            g &&
              (Za.initElement(g, function (f, c) {
                5e3 >= c.length
                  ? ((e.className = ""), (a.isActionsContainerNotifShown = !1))
                  : ((e.className = "visible"),
            ...
            this.chatTextarea.attachUserEventListener(
              ...
              function (f) {
                5e3 >= this.value.length
                  ...
                  : ((e.className = "visible"),
                    (a.isActionsContainerNotifShown = !0));
                c.isEmbedded &&
                  b.browserData.getMobileBrowser() &&
                  a.toggleMobileSubmitButton(this.value);
                a.resizeTextArea();
              },
              null,
              "chatinputkeyup"
              ...
              this.chatTextarea.attachUserEventListener(
                ...
                function (f) {
                  var c,
                    d = a.container.getElementById("hidableActionsWrapper"),
                  ...
                  setTimeout(function () {
                    c.value
                      ? ((d.style.display = "none"),
                        ...
                        l.removeClass(g, "additionalPadding"))
                      : ((d.style.display = "block"),
                        (g.className += " additionalPadding "),
          ...
          this.container.attachUserEventListener(
            b.viewHandler.clickEvent,
            function (a) {
              var e = b.eventHandler.getTargetElement(a);
              -1 !== e.className.indexOf("messageOwnerName") &&
                -1 !== e.className.indexOf("visitor") &&
          ...
          this.container.attachUserEventListener(
            ...
            function (e) {
              ...
              "touchmove" === e.type
                ...
                : "touchend" === e.type
                ? (f = m < p)
                : s.mobileBrowserName || a.chatViewScroll(e);
      ...
      S.prototype.restyleEmbed = function () {
        ...
        c.isPopup &&
          (this.wrapper.addClass("popout"), l.updateFontStylesheet(document));
      ...
      S.prototype.updateGreetings = function (a) {
        ...
        if (this.container.elementReferrer) {
          if ((e = this.container.getElementById("file-upload-drop-label")))
            e.innerHTML = b.languageParser.translate("chat", "dragDropText");
          if ((a = a || r.pageStatus()))
            (e = this.container.getElementById("shortMessage")),
          ...
          e && m >= h
            ? ((m = 150 < m ? 150 : m),
              this.isActionsContainerNotifShown &&
                ((m += 42), (f.style.paddingBottom = "42px")),
              (c.style.height = 46 + (m - h) + "px"),
      ...
      S.prototype.toggleWebRTCActions = function () {
        if (this.inDocument) {
          ...
          c.webRTCSettings() &&
            c.webRTCSettings().en &&
            ((a = c.webRTCSettings().v ? "inline-block" : "none"),
            (b = "inline-block"),
            (f = c.webRTCSettings().s ? "inline-block" : "none"));
          this.container.documentRef.getElementById(
            "videoCall"
          ).style.display = a;
          this.container.documentRef.getElementById(
      ...
      S.prototype.setChatGreetings = function (a) {
        var e,
          f = this.container.getElementById("greetingsText"),
          c = this.container.getElementById("greetingsContent");
        (e = r.pageStatus()) &&
          c &&
          f &&
          ((e = m.getLongMessage(e)),
          a && !e
            ? ((c.className += " no-content"), (c.style.display = "none"))
            : ((f.innerHTML = e.replace(l.regLineBreaks, l.br)),
              1 > b.agents.agentsCount && (c.style.display = "block"),
              a || (c.className = c.className.replace(" minimize", ""))));
      };
      S.prototype.toggleMobileSubmitButton = function (a) {
      ...
      var ja = S.extend({
        init: function () {
          ...
          b.eventEmitter.on("formClosed", function () {
            ...
            if (e)
              if (c.showPreChatForm && !r.prechatFormSubmitted())
                b.formHandler.openForm("preChatForm");
              else if (
                ...
                var f = l.getDocument(
                  l.getDocument(d).getElementById(a.container.elementId)
                );
                if (f && f.getElementById("chatTextarea"))
                  try {
                    setTimeout(function () {
        ...
        buildView: function () {
          ...
          this.insertText();
          this.wrapper &&
            this.wrapper.addClass(l.getContrast(c.headerTxtColor));
          this.attachEvents();
        },
        insertText: function () {
          var a;
          if (this.container) {
            ...
            for (var e = 0; e < a.length; e++)
              a[e].innerHTML = b.languageParser.translate(
                "form",
                "CloseButton"
              );
            (a = this.container.getElementById("uploadFileOption")) &&
              (l.isFileInputSupported
                ? a.setAttribute(
                    "title",
                    b.languageParser.translate("rollover", "uploadFile")
                  )
        ...
        init: function () {
          ...
          if (!c.isPopup && !c.isEmbedded) {
            ...
            c.isDesktopRectangle()
              ...
              : ((f = []),
                c.isRightPositioned()
                  ? f.push(this.resizeFromLeft)
                  : f.push(this.resizeFromRight),
                c.isCenterPositioned()
                  ? ((f = f.concat([
                      this.resizeFromBottom,
                      this.resizeFromTop,
                    ])),
                    (f = c.isRightPositioned()
                      ? f.concat([this.resizeTopLeft, this.resizeBottomLeft])
                      : f.concat([
                          this.resizeTopRight,
                          this.resizeBottomRight,
                        ])))
                  : c.isTopPositioned()
                  ? (f.push(this.resizeFromBottom),
                    c.isRightPositioned()
                      ? f.push(this.resizeBottomLeft)
                      : f.push(this.resizeBottomRight))
                  : (f.push(this.resizeFromTop),
                    c.isRightPositioned()
                      ? f.push(this.resizeTopLeft)
                      : f.push(this.resizeTopRight)));
          ...
          c.minStyle.subscribe(function () {
            p &&
              ...
              (p.container.insertCssFile(c.minStyle(), !0),
              (p.container.documentRef.getElementById(
                "tawkchat-minified-wrapper"
              ).className = l.getContrast(c.headerTxtColor)));
          });
          c.maxStyle.subscribe(function () {
            g &&
              g.container.elementReferrer &&
              (g.container.insertCssFile(c.maxStyle(), !0),
              g.wrapper.removeClass("black"),
              g.wrapper.removeClass("white"),
              g.wrapper.addClass(l.getContrast(c.headerTxtColor)));
          });
      ...
      F.prototype.calculateWidgetPosition = function () {
        var a,
          ...
          f =
            Math.max(
              (document.documentElement.clientHeight, d.innerHeight || 0) / 2
            ) -
            c.maximizedDimensions().height / 2,
          g = {};
        c.isDesktopRectangle()
          ? ((a = 0), (b = c.widgetOffsetX))
          : ((b = 10),
            (a = c.minimizedDimensions().height + c.widgetOffsetX + 10),
            (b = c.isCenterPositioned()
              ? c.minimizedDimensions().width + c.widgetOffsetX + b
              : b));
        c.isTopPositioned()
          ? ((g.bottom = "auto"), (g.top = a + "px"))
          : (c.isCenterPositioned()
              ? (g.bottom = c.isDesktopRectangle() ? "0px" : f + "px")
              : (g.bottom = a + "px"),
            (g.top = "auto"));
        c.isRightPositioned()
          ? ((g.right = b + "px"), (g.left = "auto"))
          : ((g.right = "auto"), (g.left = b + "px"));
        return g;
      };
      F.prototype.maximizeWidget = function () {
        ...
        p &&
          ...
          (e = p.container.getElementById("maximizeChat")));
        ...
        p &&
          ...
          (c.isDesktopRectangle()
            ...
            : (p.shown || p.show(),
              a &&
                e &&
                (l.removeClass(e, "appear"),
                l.addClass(e, "hide"),
                l.removeClass(a, "hide"),
                l.addClass(a, "appear")),
              p.hideBubble(),
              l.addClass(
        ...
        if (
          ...
          var f = l.getDocument(
            l.getDocument(d).getElementById(g.container.elementId)
          );
          if (f && f.getElementById("chatTextarea"))
            try {
              setTimeout(function () {
      ...
      F.prototype.minimizeWidget = function () {
        ...
        if (!c.isPopup && !c.isEmbedded) {
          ...
          p &&
            ...
            (f = p.container.getElementById("maximizeChat")),
            (a = p.container.getElementById("tawkchat-minified-box")));
          b &&
            f &&
            (l.removeClass(f, "hide"),
            l.addClass(f, "appear"),
            l.removeClass(b, "appear"),
            l.addClass(b, "hide"),
            l.removeClass(a, "open"));
          p.show();
      ...
      F.prototype.popoutWidget = function () {
        ...
        this.popoutWin && !this.popoutWin.closed && this.popoutWin.focus
          ...
          : (c.whiteLabel() &&
              c.whiteLabel().chatUrl &&
              (a = c.whiteLabel().chatUrl + "/chat/"),
            (this.popoutWin = d.open(
              a +
                $_Tawk_WidgetId +
                "?$_tawk_sk=" +
                r.sessionKey +
      ...
      F.prototype.insertPopupStyle = function () {
        ...
        d = document.createTextNode(
          b.ResetStyle + "" + b.MaximizedStyle + c.maxStyle()
        );
      ...
      F.prototype.begin = function () {
        ...
        b.main.started ||
          (this.iframeContainer &&
            (f = document.getElementById(this.iframeContainer.elementId)),
          f && f.parentNode.removeChild(f),
          c.isEmbedded && e
            ? (e.appendChild(this.iframeContainer.elementReferrer),
              b.eventHandler.listen(
                d,
                "resize",
                function () {
      ...
      F.prototype.onHeaderMouseDown = function (a, e, f) {
        ...
        (h.id !== this.resizeFromLeft.elementId &&
          ...
          (1 === a.button && !d.event && !g.documentRef.event) ||
          1 < a.button ||
          (b.eventHandler.cancelEvent(a),
      ...
      F.prototype.setResizedDimensions = function (a, e, f) {
        ...
        (this.isRight && "undefined" !== typeof this.isRight) ||
          (this.isRight = c.isRightPositioned());
        ...
        if (e) {
          ...
          var k = parseInt(
            ...
            m = parseInt(l.computedStyle(g, d).replace("px", ""), 10),
            p = this.isRight ? this.actualViewPortWidth - a.clientX : a.clientX,
            p = 0 > p ? 0 : p;
          (this.isRight && "right" === e) || (!this.isRight && "left" === e)
            ? ((e = k - (p - m)),
              280 > e
                ? (e = 280)
                : (p > this.actualViewPortWidth - e - 1 &&
                    (p = this.actualViewPortWidth - e - 1),
                  (g.style.cssText += ";" + d + ":" + p + "px !important"),
                  (this.startOffsetX = e)))
            : (this.startOffsetX = e = this.isRight
                ? this.actualViewPortWidth - a.clientX - m
                : a.clientX - m);
          280 <= e &&
            0 <
              this.actualViewPortWidth -
                (e + parseInt(l.computedStyle(g, d).replace("px", ""), 10)) &&
            this.setWidth(e);
        }
        f &&
          ("bottom" === f
            ? ((f = parseInt(g.style.bottom.replace("px", ""))),
              ...
              330 > f
                ? (f = 330)
                : (a > this.actualViewPortHeight - f - 1 &&
                    (a = this.actualViewPortHeight - f - 1),
                  (g.style.cssText += ";bottom:" + a + "px !important"),
                  (this.startOffsetY = f)))
            : ((startOffsetY = parseInt(
                l.computedStyle(g, "bottom").replace("px", ""),
                10
              )),
              (f = this.actualViewPortHeight - a.clientY - startOffsetY),
      ...
      F.prototype.setChatWindowXPosition = function (a) {
        var b,
          f,
          d = parseInt(g.frameWidth.replace("px", ""), 10);
        ...
        20 > a
          ? (a = 0)
          : 20 > this.actualViewPortWidth - (a + d) &&
            (a = this.actualViewPortWidth - d);
        this.iframeContainer.restyle(b, a + "px !important");
      };
      F.prototype.setChatWindowYPosition = function (a) {
        var b,
          f,
          c = parseInt(g.frameHeight.replace("px", ""), 10);
        ...
        20 > a
          ? (a = 0)
          : 20 > this.actualViewPortHeight - (a + c) &&
            (a = this.actualViewPortHeight - c);
      ...
      F.prototype.onWindowResizeTimeout = function () {
        var a = this.getActualViewportDimensions(),
          ...
          c = this.isBottom
            ? parseInt(f.style.bottom.replace("px", ""), 10)
            : parseInt(f.style.top.replace("px", ""), 10),
          d = this.isRight
            ? parseInt(f.style.right.replace("px", ""), 10)
            : parseInt(f.style.left.replace("px", ""), 10),
          h = parseInt(g.frameWidth.replace("px", ""), 10),
          k = parseInt(g.frameHeight.replace("px", ""), 10);
        h + d > b &&
          ((d = b - h),
          0 > d && ((h += d), (d = 0), this.setWidth(h)),
          this.isRight
            ? (f.style.right = d + "px")
            : (f.style.left = d + "px"));
        k + c > a &&
          ((c = a - k),
          0 > c && ((k += c), (c = 0), this.setHeight(k)),
          this.isBottom
            ? (f.style.bottom = c + "px")
            : (f.style.top = c + "px"));
      ...
      F.prototype.onEmbeddedWindowResize = function () {
        ...
        this.isWidgetElementDimensionsNull
          ? (this.setWidth(c.maximizedDimensions().width),
            this.setHeight(c.maximizedDimensions().height))
      ...
      F.prototype.expandAgentList = function (a) {
        ...
        if ((f = this.chatContainer))
          (b = f.getElementById("agentBar")),
            (f = f.getElementById("expandableLink")),
            (1 === a.button && !d.event) ||
              1 < a.button ||
              (-1 === b.className.indexOf("expanded")
                ? ((b.className += " expanded"), (f.className = "expanded"))
      ...
      F.prototype.resetView = function () {
        var a, b, f, c, d;
        if ((c = this.chatContainer))
          (a = c.getElementById("chatWrapper")),
            (f = c.getElementById("agentList")),
            (d = c.getElementById("agentBar")),
            (c = c.getElementById("expandableLink")),
            a && ((b = a.lastChild), (a.innerHTML = ""), a.appendChild(b)),
            f && (f.innerHTML = ""),
            d &&
              ((a = d.parentNode.childNodes[0]),
              (d.className = ""),
              a &&
                -1 !== a.className.indexOf("agentWrapper") &&
                a.parentNode.removeChild(a)),
            c && ((c.style.visibility = "hidden"), (c.className = "")),
            this.show();
      };
      ...
      var cb = F.extend({
          ...
          handleEndChat: function () {
            ...
            c.isEmbedded ||
              (c.isPopup
                ...
                : (b.sessionHandler.notifyWindowState("min"), g.chatEnded()));
          },
          handleRestartChat: function () {
            b.formHandler.closeForm();
            g.chatStarted();
        ...
        ca = function () {
          ...
          c.isCenterPositioned() &&
            "rectangle" === c.mobileWidget() &&
            (c.isRightPositioned()
              ? ((e.transform = "rotate(-90deg)"), (e.right = "0px"))
              : ((e.left = "0px"), (e.transform = "rotate(90deg)")));
          this.container = new N(
            l.getRandomName(),
            l.getGenericStyle(e),
            Y,
          ...
          c.mobMinStyle.subscribe(function () {
            a.container &&
              ...
              a.container.insertCssFile(c.mobMinStyle(), !0);
          });
          c.showMessagePreview.subscribe(function () {
            c.showMessagePreview()
              ? a.initMessagePreviewContainer()
        ...
        if (this.container && a) {
          ...
          if ((e = this.container.getElementById("tawk-minified-mobile-text")))
            e.innerHTML =
              "online" === a || "away" === a
                ? b.languageParser.translate("chat", "chat_text")
                : b.languageParser.translate("form", "message");
          try {
            b.eventEmitter.emit("resizeIframeHeight");
          } catch (f) {
            q.handleError(
      ...
      ca.prototype.updateWidgetPosition = function () {
        ...
        this.container &&
          this.container.elementReferrer &&
          ((a = c.isCenterPositioned()
            ? a + " center "
            : c.isTopPositioned()
            ? a + " top "
            : a + " bottom "),
          (a = c.isRightPositioned() ? a + " right " : a + " left "),
          (a += " " + c.mobileWidget() + " "),
      ...
      var C = function (a) {
        ...
        arguments.length &&
          ...
          (this.isTherePreChat = c.showPreChatForm),
          (this.noZoomMetaTag = null),
          (this.isIndicatorOn = !1),
          (this.scrollTop = this.scrollLeft = 0),
          (this.mainAgent = null),
          this.shapeChanged(),
          (this.minifiedWidget = new ca()),
          (g = new ja(this.tawktoLinkName, this.bottomContainerName)),
          g.wrapper.addClass("mobile"),
          (this.iframeContainer = new D(
            l.getRandomName(),
          ...
          (this.indicator = new ia(this.minifiedWidget.container)),
          this.iframeContainer.addChildViews([
            this.minifiedWidget.container,
            g.container,
          ]),
          "#max-widget" === d.location.hash &&
            (d.history
              ? d.history.replaceState({}, document.title, ".")
              : (d.location.hash = "")),
          this.iframeContainer.buildView(),
          (this.chatContainer = g.container),
          ...
          r.chatWindowState.subscribe(function (a) {
            c.isPopup ||
              (e.hideWidget(),
              "max" === a
                ? (k.disableMobileBackHistory ||
                    (d.location.hash && "#max-widget" !== d.location.hash) ||
                    (d.history.pushState
                      ? d.history.pushState(
                          null,
                          null,
                          d.location.href + "#max-widget"
                        )
                      : (d.location.hash = "max-widget")),
                  e.maximize())
                : (k.disableMobileBackHistory ||
                    ("#max-widget" === d.location.hash && d.history.back()),
                  (e.isMaximized = !1),
                  e.show()));
          }),
          r.pageStatus.subscribe(function (a) {
          ...
          c.maxStyle.subscribe(function () {
            e.chatContainer &&
              e.chatContainer.elementReferrer &&
              e.chatContainer.insertCssFile(c.maxStyle(), !0);
          }),
      ...
      C.prototype.shapeChanged = function () {
        (this.isMinifiedRound = "round" === c.mobileWidget() ? !0 : !1)
      ...
      C.prototype.show = function () {
        ...
        this.isMaximized
          ...
          : (this.isMobileOptimizedWebsite()
            ...
            l.blurElements(
              g.container.documentRef.body.getElementsByTagName("input")
            ),
            l.blurElements(
              g.container.documentRef.body.getElementsByTagName("textarea")
            ),
            this.isVisibilityToggled ||
      ...
      C.prototype.checkMetaContent = function () {
        ...
        if (f) {
          for (
            var f = f.replace(/ /g, ""), f = f.split(","), c = 0, d = f.length;
            c < d;
            c++
          )
            (a = f[c].split("=")), (b[a[0]] = a[1]);
      ...
      C.prototype.ifScrollbarDown = function () {
        ...
        if ((a = document.body))
          return (
            ...
            (f = a.scrollTop || document.documentElement.scrollTop),
            80 > a.scrollHeight - (f + b)
          );
      };
      ...
      C.prototype.getMetaContent = function () {
        ...
        for (b = f.length; a < b; a++)
          f[a].getAttribute("name") &&
            "viewport" === f[a].getAttribute("name").toLowerCase() &&
            (c = f[a].getAttribute("content"));
        return c;
      };
      ...
      C.prototype.resizeMobileRectangleWidget = function () {
        var a = this.minifiedWidget.container.getElementById(
          ...
          f = this.minifiedWidget.container.getElementById(
            "tawkchat-minified-wrapper"
          ),
          d = "safari" !== s.mobileBrowserName ? screen.width : screen.height;
        "rectangle" === c.mobileWidget() &&
          ((a.style.width = ""),
          (this.minifiedBoxWidth = a.offsetWidth + 41),
          110 > this.minifiedBoxWidth
            ? (this.minifiedBoxWidth = 110)
            : !this.isLandscape() && this.minifiedBoxWidth > screen.width
            ? ((this.minifiedBoxWidth = screen.width - 41),
              (a.style.width = "calc(100% - 41px)"))
            : this.isLandscape() &&
              this.minifiedBoxWidth > d &&
              ((this.minifiedBoxWidth = d - 41),
              (a.style.width = "calc(100% - 41px)")),
          !this.isLandscape() && this.minifiedBoxWidth > screen.width - 41
            ? (this.minifiedBoxWidth = screen.width - 41)
            : this.isLandscape() &&
              this.minifiedBoxWidth > d - 41 &&
              (this.minifiedBoxWidth = d - 41 - 10),
          (f.style.width = this.minifiedBoxWidth + "px"),
          c.isRTL()
      ...
      C.prototype.scaleContent = function (a) {
        if (!this.isMaximized) {
          ...
          a &&
            ...
            (g.style.cssText += h + b),
            c.isRTL() && !g.classList.contains("rtl-direction")
      ...
      C.prototype.maximize = function () {
        ...
        "pop" === c.onClickAction
          ? this.popup()
          : (this.messagePreview && this.messagePreview.hide(),
            this.hasChatStarted || (c.showPreChatForm = this.isTherePreChat),
            this.indicator.hide(),
            this.minifiedWidget.container.hide(),
      ...
      C.prototype.renderBottomWidget = function () {
        this.isMaximized ||
          ...
          (this.minifiedWidget.container.template =
            t["mobile-bottom-" + c.mobileWidget()]),
      ...
      C.prototype.handleIndicatorToggle = function (a) {
        ...
        f.className = a
          ? f.className + " indicator-on "
          : f.className.replace("indicator-on", "");
        this.isMobileOptimizedWebsite()
          ? this.scaleContent(1)
      ...
      C.prototype.updateViewByStatus = function (a, b) {
        this.isMaximized
          ...
          : this.iframeContainer.elementReferrer &&
            ("offline" === a && c.hideWidgetOnOffline
              ? this.hideWidget()
              : this.showWidget(),
            this.resizeHandler());
      };
      ...
      C.prototype.addOverflowScroll = function (a) {
        ...
        b.eventHandler.listen(
          ...
          function (c) {
            ...
            20 >= c.touches[0].pageY ||
              0 > e - c.touches[0].pageY ||
              ((a.scrollTop = e - c.touches[0].pageY),
      ...
      C.prototype.renderAgentMinimizedWidget = function (a) {
        ...
        if (a) {
          if (
            ...
            "round" === c.mobileWidget() && (f.style.display = "none"),
      ...
      pa.prototype.getZoom = function () {
        this.zoom =
          (this.isLandscape() ? screen.height : screen.width) / d.innerWidth;
      };
      ...
      var fa = y.extend({
        init: function () {
          ...
          f.styleSheet
            ? (f.styleSheet.cssText = d.nodeValue)
            : f.appendChild(d);
          e.appendChild(f);
          a.appendChild(e);
          this.chatContainer = g.container;
      ...
      var ga = function () {
        ...
        b.eventEmitter.on("scheduleUpdate", function (b) {
          c.widgetId === b.wdgt &&
            ((c.schedule = b.ws ? a.convertOldScheduleFormat(b.ws.sch) : null),
            (c.scheduleTimezone =
      ...
      ga.prototype.setup = function () {
        ...
        c.schedule
          ? ((this.utcOffset =
              -1 * (new Date().getTime() - c.scheduleTimezone.utc)),
            this.calculate())
      ...
      ga.prototype.calculate = function () {
        ...
        if (c.schedule)
          if (0 === c.schedule.length) this.goOffline();
            ...
            f = new Date(a.getTime() + this.utcOffset + b);
            a = f.getDay();
            ...
            void 0 !== d
              ? (this.goOnline(), (d = 60 * d.end - f))
              : (this.goOffline(),
                (d = void 0 !== g ? 60 * g.start - f : 86400 - f + 1));
            void 0 !== d &&
      ...
      V.prototype.prepareData = function () {
        ...
        if (b) {
          ...
          if (-900 > f || 900 < f) f = 0;
          this.registerData
            ? ((this.registerData.k = e), (this.registerData.d = g))
            : ((d = b.browserData.getReferredSearchEngine()),
              (this.registerData = {
                a: L.pageId || "",
                k: e,
                w: c.widgetId,
          ...
          if (4 === r.length)
            if (((m = r[0]), (p = r[1]), (q = r[2]), (r = r[3]), "e" === m)) {
              ...
              "p" === m &&
                ...
                h.substr(m.index) === p &&
                m.index < g &&
                ((g = m.index), (e = q), (f = r), (c = !0));
        }
        this.registerData &&
          ((this.registerData.u = e),
          (this.registerData.uv = f),
          c && (this.registerData.uw = !0));
        this.startRegister();
      };
      V.prototype.abort = function () {
        null !== this.previousRegisterCall &&
          (Ha.abort(this.previousRegisterCall),
      ...
      V.prototype.startRegister = function () {
      ...
      V.prototype.doRegister = function () {
        ...
        this.previousRegisterCall = Ha.xhrRequest(
          a,
          this.registerData,
          function (a, c) {
      ...
      ha.prototype.processSettings = function (a) {
        ...
        if (!(a.wv < c.widgetVersion)) {
          Tawk_API.embedded && (c.isEmbedded = !0);
          c.isHeaderCompact = !1;
          ...
          "full" === a.dw
            ? ((c.widgetOffsetX = 10), (c.widgetOffsetY = 0))
            : ((c.widgetOffsetX = 20), (c.widgetOffsetY = 20));
          s.mobileBrowserName
            ? c.mobileWidget(a.mw || "round")
            : c.desktopWidget(a.dw || "min");
          c.maximizedDimensions({
            width: parseInt(a.w, 10) || 350,
            height: parseInt(a.h, 10) || 520,
          });
          c.isDesktopRectangle() &&
            ((e = parseInt(a.minw, 10) || 320),
            (f = parseInt(a.minh, 10) || 40));
          c.chatBubble(a.bbl);
          c.headerBgColor = a.thm.hbg || "#03a84e";
          c.headerTxtColor = a.thm.htx || "#ffffff";
          c.agentTextBgColor =
            a.thm.aBblBg || l.shadeColor(c.headerBgColor, -0.1);
          ...
          c.bottomCorner =
            "undefined" !== typeof a.thm.btmc
              ...
              ? 8
              : 0;
          if (c.isEmbedded || c.isPopup)
            (c.topCorner = 0), (c.bottomCorner = 0);
          ...
          b &&
            ((e =
              ...
              c.headerBgColor +
              ";}"),
            (f = ".theme-text-color{color: " + c.headerTxtColor + ";}"),
            c.showEmoji() && (g += 30),
            c.showRating() && (g += 30),
            c.showUploads() && (g += 30),
            b.MinifiedStyle &&
              ...
              (k +=
                ...
                c.headerTxtColor +
                "}"),
              (k += "#file-upload-drop-icon {color:" + c.headerBgColor + ";}"),
              (k += "#tawkchat-status-container{left: 10px;}"),
              (k +=
              ...
              (k += "#chat-icon-svg { fill:" + c.headerTxtColor + "};"),
              c.minStyle(k),
            ...
            b.MaximizedStyle &&
              ...
              (h +=
                ...
                c.headerTxtColor +
                "}"),
              (h += "#file-upload-drop-icon {color:" + c.headerBgColor + ";}"),
              (h +=
              ...
              (h +=
                ...
                l.shadeColor(c.headerBgColor, -0.3) +
                "!important;}"),
              (h +=
              ...
              (h +=
                ...
                c.visitorTextBgColor +
                ";}"),
              (h += ".agentNameCentered{color:" + c.headerTxtColor + ";}"),
              (h +=
                "#textareaContainer.additionalPadding{padding-right: " +
                g +
                "px;}"),
            ...
            b.MinifiedMobileStyle &&
              ...
              (m += "#chat-icon-svg { fill:" + c.headerTxtColor + "};"),
              c.mobMinStyle(m),
      ...
      ha.prototype.getShortMessage = function (a) {
        ...
        "online" === a && c.onlineGreeting
          ? (b = c.onlineGreeting.shortMessage)
          : "away" === a && c.awayGreeting
          ? (b = c.awayGreeting.shortMessage)
          : "offline" === a &&
            c.offlineOptions &&
            (b = c.offlineOptions.shortMessage);
        return b;
      };
      ha.prototype.getLongMessage = function (a) {
        var b = null;
        "online" === a && c.onlineGreeting
          ? (b = c.onlineGreeting.longMessage)
          : "away" === a && c.awayGreeting
          ? (b = c.awayGreeting.longMessage)
          : c.offlineOptions && (b = c.offlineOptions.text);
      ...
      var $ = function () {
        ...
        b.eventEmitter.on("requestEmailTranscript", function (a, f) {
          ...
          b.chatHandler.hasChatEnded
            ? b.socketManager.sendToConnector("notifyEndChatTranscript", a, f)
            : b.socketManager.sendToConnector("notifyEmailTranscript", a, f);
        });
      };
      $.prototype.updateVisitorUUID = function (a) {
        ...
        b &&
          (Object.keys(b.e).forEach(function (a) {
            z.uuids.push({ isExact: !0, domain: a, uuid: b.e[a] });
          }),
          Object.keys(b.p).forEach(function (a) {
            z.uuids.push({ isExact: !1, domain: a, uuid: b.p[a] });
          }));
        aa.storeUUID();
      };
      ...
      $.prototype.setNameFromForm = function (a) {
      ...
      $.prototype.setTranscriptValue = function (a) {
        a.name && z.name(l.rawEncode(a.name));
        z.transcriptEmail = a.transcriptEmail;
      };
      $.prototype.sendNavigationEvent = function () {
        var a = this;
        setTimeout(function () {
          var e = { u: d.location.href, t: document.title };
          b &&
            (b.viewHandler &&
              b.viewHandler.indicator &&
              0 < b.viewHandler.indicator.unansweredMessages &&
              (e.t = b.viewHandler.indicator.originalPageTitle),
            document.referrer &&
              a.referrer !== document.referrer &&
              ((a.referrer = document.referrer), (e.r = document.referrer)),
            b.socketManager.sendToConnector("nav", e));
        }, 500);
      };
      var Q = function () {
        var a = this;
      ...
      Q.prototype.getDeparmentOptions = function () {
        ...
        for (e = g.length; a < e; a++)
          (c = g[a]),
            d.push({
              text:
                c.n + " (" + b.languageParser.translate("status", c.st) + ")",
              value: c.did,
      ...
      Q.prototype.formatPrechatData = function (a, e) {
        ...
        b.socketManager.sendToConnector("notifyPrechat", d, function (a) {
          if (a) return e(a, d);
          k.triggerApiHandlers("onPrechatSubmit", d.questions);
          b.viewHandler.indicator.pageTitleNotification.off();
      ...
      Q.prototype.handlePrechatSave = function (a, e) {
        ...
        if (0 < a.questions.length)
          for (c = 0, d = a.questions.length; c < d; c++)
            (g +=
              l.rawDecode(a.questions[c].label) +
              " : " +
              a.questions[c].answer),
              c !== d - 1 && (g += "\r\n");
      ...
      Q.prototype.formatOfflineData = function (a, e) {
        ...
        b.socketManager.sendToConnector("notifyOfflineMessage", c, function (
          a
        ) {
          if (a) return e(a, c);
      ...
      Q.prototype.visitorChatDismiss = function (a) {
        var e;
        b.chatHandler.messages &&
          ((e = Object.keys(b.chatHandler.messages)),
          (e = e[e.length - 1]),
          (e = b.chatHandler.messages[e]) &&
            e.co &&
            ((e = new Date(e.co).getTime()),
            b.socketManager.sendToConnector(
              "visitorChatDismiss",
              { timestamp: e },
              function (b) {
      ...
      Q.prototype.setAttributes = function (a, c, f) {
        ...
        c
          ? ((k.visitor = k.visitor || {}),
            a.name && (k.visitor.name = a.name),
            a.email && (k.visitor.email = a.email),
            a.hash && (k.visitor.hash = a.hash))
      ...
      Q.prototype.secureWrapper = function (a) {
        ...
        k &&
          k.visitor &&
          (k.visitor.email && (a.email = k.visitor.email),
          k.visitor.hash && (a.hash = k.visitor.hash));
        return a;
      };
      Q.prototype.setVisitorAttributes = function () {
        ...
        k &&
          k.visitor &&
          (k.visitor.name && (a.name = k.visitor.name),
          k.visitor.email && (a.email = k.visitor.email),
      ...
      I.prototype.parseHistory = function (a) {
        ...
        v.chatEndVersion = 1;
        e = 0;
        for (f = v.chatHistory.length; e < f; e++)
          "CHAT_ENDED" === v.chatHistory[e].m &&
            ((d = e + 1), v.chatEndVersion++);
        g = 0 < v.chatOrder ? this.messages[v.chatOrder] : null;
        e = d;
        for (f = v.chatHistory.length; e < f; e++)
          (d = v.chatHistory[e]),
            (d.md && (!d.md || d.md.ao)) ||
              (a && g && g.timeStamp > new Date(d.co).getTime()) ||
              ("v" !== d.ut ||
                this.visitorHasMessaged ||
                "c" !== d.t ||
                (h = new Date().getTime() - l.getMilliseconds(d.co)),
              "WEBRTC_CALL" === d.m && d.md && d.md.webrtc
                ? ((this.hasWebRTCall = !0),
                  b.viewHandler.subscribeCallUpdate(d.md.clid, !0))
                : this.prepareMessage(d, !0, !1, !1));
        this.noRedraw = !1;
        this.visitorHasMessaged &&
      ...
      I.prototype.handleMessageFromServer = function (a) {
        ...
        "WEBRTC_CALL" === a.m && a.md && a.md.webrtc
          ...
          ? ("v" === a.ut && "c" === a.t && b.viewHandler.addWaitTime(),
            ...
            (v.chatVersion = a.cver),
            "s" === a.ut ||
              "c" !== a.t ||
              this.hasChatStarted() ||
              (this.hasChatStarted(!0),
              k.triggerApiHandlers("onChatStarted", { chatId: v.chatId })),
            "c" === a.t
              ? "a" === a.ut
                ? a.md && a.md.file
                  ? k.triggerApiHandlers(
                      "onFileUpload",
                      "https://tawkto.link/" + a.md.file.name
                    )
                  : k.triggerApiHandlers("onChatMessageAgent", a.m)
                : "s" === a.ut &&
                  k.triggerApiHandlers("onChatMessageSystem", a.m)
              : "n" === a.t &&
                ("AGENT_JOIN_CONVERSATION" === a.m
                  ? (a.md &&
                      a.md.pi &&
                      a.md.pi.length &&
                      (e = "https://s3.amazonaws.com/talk-pi/" + a.md.pi),
                    k.triggerApiHandlers("onAgentJoinChat", {
                      name: a.n,
                      position: a.md.pst,
                      image: e,
                      id: a.uid,
                  ...
                  : "AGENT_LEFT_CONVERSATION" === a.m &&
                    k.triggerApiHandlers("onAgentLeaveChat", {
                      name: a.n,
                      id: a.uid,
                    })),
            this.prepareMessage(a, !1),
            b.scheduler.calculate())
          : ((v.chatId = a.md.nchid), this.endChat(a.md.cev));
      };
      I.prototype.prepareMessage = function (a, c, f, d) {
        ...
        "n" === a.t && "v" === a.ut
          ...
          : ("v" === a.ut
              ? ((g = z.displayName()), (h = a.uid))
              : ((g = a.n),
                "a" === a.ut
                  ? (h = v.profiles[a.md.rsc])
                  : "s" === a.ut && a.md && (l = a.md.pi)),
            "n" !== a.t ||
              ("AGENT_JOIN_CONVERSATION" !== a.m &&
                "AGENT_LEFT_CONVERSATION" !== a.m) ||
              ((m = !1),
              b.agents.updateAgentPresence(a.m, a.md, a.n, a.md.rsc, !f)),
            m &&
              (k || (k = this.parseText(a.m)),
              void 0 === c && (c = !0),
              ...
              d || v.chatOrder++,
              (this.messages[v.chatOrder] = a)));
      };
      I.prototype.parseText = function (a) {
        if (a)
          return (
            (a = a.replace(l.regLineBreaks, l.br)),
      ...
      I.prototype.createUrl = function (a, c) {
        ...
        for (k = a.length; h < k; h++)
          -1 !== a[h].indexOf(l.br)
            ? ((g = a[h].split(l.regBr)), (a[h] = this.createUrl(g, l.br)))
            : a[h].match(l.regEmailMatch)
            ? (a[h] = a[h].replace(l.regEmailMatch, d))
            : ((a[h] = a[h].replace(l.regMatchUrl, f)),
              (a[h] = a[h].replace(l.regMatchIp, f)));
        return a.join(c);
      };
      I.prototype.parseUrl = function (a) {
        var b,
          c = "";
        ...
        if ("mailto:" === c)
          return (
            (b = a.match(l.regEmailMatch)[0]),
            -1 !== b.indexOf("mailto") && (c = ""),
            a.replace(
              l.regEmailMatch,
              '<a href="' +
                (c + b) +
      ...
      I.prototype.sendTextPreview = function (a) {
        ...
        if (13 === a.keyCode && !a.shiftKey && !s.mobileBrowserName)
          return (
            b.eventHandler.cancelEvent(a),
            (f = l.trim(e.value)),
            (e.value = ""),
      ...
      I.prototype.conversationUpdate = function (a) {
        ...
        if (!(v.chatVersion >= d)) {
          a = 0;
          for (e = f.length; a < e; a++) f[a].cver > d && g.push(f[a]);
          a = 0;
          for (e = g.length; a < e; a++)
            (f = g[a]), (f.md && f.md.ao) || this.prepareMessage(f, !1);
          this.visitorHasMessaged &&
            !this.agentHasMessaged &&
            c.showWaitTime &&
            b.viewHandler.addWaitTime();
      ...
      I.prototype.changeRating = function (a, c) {
        ...
        c ||
          ...
          k.triggerApiHandlers("onChatSatisfaction", v.rating()));
      };
      I.prototype.toggleSound = function (a) {
        var e = !c.soundOn();
        void 0 !== a && (e = a);
        c.soundOn(e);
      ...
      I.prototype.sendFileMessage = function (a) {
        ...
        b.socketManager.sendToConnector("fileUploadMessage", f, function (
          d,
          g,
          h
        ) {
          d ||
            ...
            (f.fileName = l.rawEncode(f.fileName)),
            ...
            k.triggerApiHandlers(
              "onFileUpload",
              "https://tawkto.link/" + f.name
            ));
        });
      };
      I.prototype.isChatOngoing = function () {
        return (
          !this.hasChatEnded &&
          this.visitorHasMessaged &&
          0 < b.agents.totalAgents()
      ...
      ma.prototype.addAgentToList = function (a, c, f, d) {
        ...
        if (g)
          if (
            g.seq.time < a.seq.time ||
            (g.seq.time === a.seq.time && g.seq.inc < a.seq.inc)
          ) {
            g.seq = a.seq;
        ...
        if ("undefined" !== typeof v.agentProfiles[a.pid])
          return (
            (v.agentProfiles[a.pid].pi = a.pi),
            v.agentProfiles[a.pid].count++,
            !1
          );
      ...
      ma.prototype.changeAgentProfile = function (a, c) {
        var f;
        f = v.agentProfiles[a];
        this.decrementProfileCount(a, c) &&
          ...
          v.chatOrder++,
          (b.chatHandler.messages[v.chatOrder] = f),
          b.viewHandler.appendMessage(f));
      };
      ma.prototype.removeAgentFromList = function (a, b, c) {
        ...
        b = d.pid;
        if (
          d.seq.time < a.seq.time ||
          (d.seq.time === a.seq.time && d.seq.inc < a.seq.inc)
        )
          (d.seq = a.seq), (d.pid = null);
        else return !1;
        this.totalAgents(this.totalAgents() - 1);
      ...
      da.prototype.sendToConnector = function (a, b, c) {
        if (u.connected)
          if (void 0 !== c || "function" === typeof b)
            this.safeCallback(a, b, c);
          else
            try {
      ...
      da.prototype.addToStack = function (a, b, c) {
        ...
        "notifyMessagePreview" === a
          ? (this.events[a] = { command: a, data: b, callback: c })
      ...
      da.prototype.safeCallback = function (a, b, c) {
        ...
        try {
          null === b
            ? this.socketConnector.emit(a, g)
            : this.socketConnector.emit(a, b, g);
        } catch (h) {
          q.handleError(
      ...
      T.prototype.init = function () {
        ...
        if (
          ...
          (e = l.parseQueryString()),
          !e.$_tawk_beacon && "operamini" !== s.mobileBrowserName)
        ) {
          if ((a = l.getReloadedScript()))
            (a = l.parseQueryString(a.src)),
              (r.restarted = a.restarted),
              (this.maximize = a.maximized);
          X();
          k.isPopup &&
            ((r.transferKey = e.$_tawk_tk),
            (r.sessionKey = e.$_tawk_sk),
            (c.isPopup = !0));
          k.embedded && ((c.isEmbedded = !0), (s.mobileBrowserName = null));
          s.mobileBrowserName
            ? (c.isPopup
                ? (b.viewHandler = new fa())
                : this.initRenderer(s.mobileBrowserName),
              (b.formHandler = new J()))
            : ((b.formHandler = new J()), (b.viewHandler = new cb()));
          b.viewHandler &&
            (b.sessionHandler.setVisitorAttributes(),
            k.triggerApiHandlers("onBeforeLoad"),
            this.bootStrap());
        }
      };
      ...
      T.prototype.extractRegisterData = function (a) {
        a.wdgt &&
          (a.wdgt.lc !== u.widgetSettings.lc &&
            ...
            l.insertScript(
              "https://static-v.tawk.to/695/languages/" + a.wdgt.lc + ".js"
            )),
          m.processSettings(a.wdgt));
        a.rcf && c.consentOption
          ? ((this.needConsent = !0), (c.showConsentForm = !0))
          : ((this.needConsent = !1), (c.showConsentForm = !1));
        "max" !== c.onClickAction ||
          s.mobileBrowserName ||
      ...
      T.prototype.criticalRefresh = function (a, e, f) {
        ...
        var m = setInterval(function () {
          d.$_Tawk.startTime !== g.startTime &&
            ((b = null),
            clearInterval(m),
            clearTimeout(g.versionReloadTimeout));
        }, 200);
      };
      T.prototype.removeWidget = function () {
        ...
        "undefined" !== typeof l.messagePreviewCheckWhiteLabelRef &&
          clearTimeout(l.messagePreviewCheckWhiteLabelRef);
        a && a.parentNode.removeChild(a);
      };
      ...
      ta.prototype.translate = function (a, b, c, d) {
        ...
        if (0 < b) {
          for (a = 0; a < b; a++)
            g.push(k.pluralFormFunction(c[d.pluralVars[a]]));
          g = d.message[g.join("_")];
          for (a = 0; a < b; a++)
            g = g.replace(
              RegExp("#" + d.pluralVars[a], "g"),
              this.escapeStringReplacePlacement(c[d.pluralVars[a]])
            );
        } else g = d.message;
        if (0 < h)
          for (a = 0; a < h; a++)
            g = g.replace(
              RegExp("#" + d.vars[a], "g"),
              this.escapeStringReplacePlacement(c[d.vars[a]])
            );
        return g;
      };
      ...
      b.scheduler = new ga();
      b.main = new T();
      b.languageParser = new ta(u.language);
      ...
      if (void 0 !== u.downloaded)
        ...
        u.downloaded = !0;
        if (
          "undefined" !== typeof d.Prototype &&
          "string" === typeof d.Prototype.Version &&
          1.7 > parseFloat(d.Prototype.Version.substr(0, 3), 10) &&
